...
-   An attestation signed driver will not work for other versions of Windows, such as Windows Server 2016.
-   An attestation signed driver will not work for previous versions of Windows, such as Windows 7 or Windows 8.1.
...
6. Submit the EV signed Cab file using the Windows Hardware Developer Center Dashboard
...
You can certify your devices and apps for hardware certification using the Windows Dev Center hardware dashboard. To access the Windows Dev Center hardware dashboard, you’ll need to register your company and get a code signing certificate.
...
1. Submit the EV signed Cab file using the Windows Hardware Developer Center Dashboard. For more information see [Driver Signing Properties](driver_signing_properties.md) and [File Signing Services](https://msdn.microsoft.com/en-us/Library/Windows/Hardware/Dn771767.aspx).
...
2. When the signing process is complete, download your signed driver from the Windows Hardware Developer Center Dashboard.
