...
### <a id="coloredconsoleoutputtruefalse">:::no-loc text="/coloredConsoleOutput:\<true/false>":::</a>
...
### <a id="consoleoptionnamevalue">:::no-loc text="/console:\<optionName>=\<value>":::</a>

Provides options for configuring TE's use of the console. The following options are available:

#### <a id="consoleflushwrites">:::no-loc text="/console:flushWrites":::</a>
...
#### <a id="consoletopmost">:::no-loc text="/console:topmost":::</a>
...
### <a id="isolationlevellevel">:::no-loc text="/isolationLevel:\<Level>":::</a>
...
### <a id="nametestname">:::no-loc text="/name:\<testname>":::</a>
...
### <a id="outputfolderfoldername">:::no-loc text="/outputFolder:\<folderName>":::</a>
...
### <a id="pparamnameparamvalue">:::no-loc text="/p:\<ParamName>=\<ParamValue>":::</a>
...
### <a id="pictoptionnameoptionvalue">:::no-loc text="/pict:\<OptionName>=\<OptionValue>":::</a>
...
### <a id="runasrunastype">:::no-loc text="/runas:\<RunAsType>":::</a>
...
### <a id="runonmachinename">:::no-loc text="/runon:\<MachineName>":::</a>
...
### <a id="selectquery">:::no-loc text="/select:\<query>":::</a>
...
### <a id="sessiontimeoutvalue">:::no-loc text="/sessionTimeout:\<value>":::</a>
...
### <a id="testdependenciesfiles">:::no-loc text="/testDependencies:\<files>":::</a>
...
### <a id="testtimeoutvalue">:::no-loc text="/testTimeout:\<value>":::</a>
...
### <a id="unicodeoutputtruefalse">:::no-loc text="/unicodeOutput:\<true/false>":::</a>
...
### <a id="logfilename">:::no-loc text="/logFile:\<name>":::</a>
...
### <a id="logoutputmode">:::no-loc text="/logOutput:\<mode>":::</a>
...
### <a id="wttdevicestringvalue">:::no-loc text="/wttDeviceString:\<value>":::</a>
...
### <a id="wttdevicestringsuffixvalue">:::no-loc text="/wttDeviceStringSuffix:\<value>":::</a>
...
### <a id="stackframecountvalue">:::no-loc text="/stackFrameCount:\<value>":::</a>
...
### <a id="testmodeloop">:::no-loc text="/testmode:Loop":::</a>
...
### <a id="testmodestress">:::no-loc text="/testmode:Stress":::</a>
