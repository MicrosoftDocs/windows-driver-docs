...
The driver library processes most of the IOCTL requests that the resource manager sends to the reader driver. The [Smart Card Driver IOCTLs](https://docs.microsoft.com/windows-hardware/drivers/ddi/index) section, lists the IOCTLs that the driver library processes on behalf of the reader driver.
