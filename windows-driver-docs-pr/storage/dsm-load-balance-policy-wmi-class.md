...
When this class definition is compiled by the WMI tool suite, it produces the [**DSM\_Load\_Balance\_Policy**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/mpiodisk/ns-mpiodisk-_dsm_load_balance_policy) data structure. There are no methods associated with this WMI class.
