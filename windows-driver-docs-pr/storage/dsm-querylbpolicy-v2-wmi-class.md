...
When this class definition is compiled by the WMI tool suite, it produces the [**DSM\_QueryLBPolicy\_V2**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/mpiodisk/ns-mpiodisk-_dsm_querylbpolicy_v2) data structure. There are no methods associated with this WMI class.
