...
* WinPE Only – Indicates support only in WinPE editions of Windows.
* Comments – Any additional relevant information; for example, whether supported as part of an IOCTL operation.

| Feature or Extended Capability | NVMe 1.4 (Features) | NVMe 2.0 (Caps) Base | NVMe 2.0 (Caps) NVM | NVMe 2.0 (Caps) ZNS | StorNVMe Supported | WinPE Only | Comments |
| -- | -- | -- | -- | -- | -- | -- | -- |
...
| Namespace Management   | 8.12 | 8.11 | 5.3 |  | Yes | Yes | Available through [IOCTL_STORAGE_PROTOCOL_COMMAND](/windows-hardware/drivers/ddi/ntddstor/ni-ntddstor-ioctl_storage_protocol_command) |
