...
When the WMI tool suite compiles this class definition, it produces the [**ISCSI\_DiscoveredTargetPortalGroup**](https://msdn.microsoft.com/library/windows/hardware/ff561515) data structure.
