...
When compiled by the WMI tool suite, this class definition produces the [**MPIO\_DISK\_INFO**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/mpiowmi/ns-mpiowmi-_mpio_disk_info) data structure. There are no methods associated with this WMI class.
