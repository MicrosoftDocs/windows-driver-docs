...
When [**ScsiPortInitialize**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/srb/nf-srb-scsiportinitialize) returns control, the [**DriverEntry**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/index) routine propagates the return value of **ScsiPortInitialize** when **DriverEntry** itself returns control.
