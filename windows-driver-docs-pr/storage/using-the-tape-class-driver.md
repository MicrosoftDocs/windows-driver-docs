...
See [Tape Class Driver Routines](https://docs.microsoft.com/windows-hardware/drivers/ddi/index) for descriptions of the **TapeClass***Xxx* routines that can be called by a tape miniclass driver.
