...
To accomplish this, they encapsulate the LED device in a component and provide a separate LED controller driver package [`osrfx2_DCHU_usersvc.inx`] along with the base driver package to install the service.
...
The following snippet from [`osrfx2_DCHU_base.inx`] shows how the primary driver package adds a custom capability to the device interface instance:
