...
This code sample fails the API Layering requirement of Windows Drivers with the following [ApiValidator](validating-universal-drivers.md) errors:
...
This sample shows how to call [**IsApiSetImplemented**](https://docs.microsoft.com/windows/desktop/api/apiquery2/nf-apiquery2-isapisetimplemented). This sample passes the API Layering requirement of Windows Drivers with the following [ApiValidator](validating-universal-drivers.md) output:
...
* [Validating Windows Drivers](https://docs.microsoft.com/windows-hardware/drivers/develop/validating-universal-drivers)
