...
<td align="left"><p>Specifies additional options to pass to the [<strong>Message Compiler (MC.exe)</strong>](https://msdn.microsoft.com/en-us/Library/Windows/Hardware/Aa385638) tool.</p></td>
</tr>
<tr class="even">
