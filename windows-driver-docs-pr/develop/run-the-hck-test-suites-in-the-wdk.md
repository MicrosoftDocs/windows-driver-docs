...
### Select an HCK test suite to run on a test computer

1. From the **Driver** menu, select **Test** and then select **Test Group Explorer**.
1. In the **Driver Test Group Explorer** window, select one of the [HCK test suites](#hck-test-suites). When you select a test suite it appears in the **Driver Test Group** window.
