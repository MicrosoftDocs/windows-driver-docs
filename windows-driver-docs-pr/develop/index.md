...
To set up the integrated development environment, first install Visual Studio and then install the WDK. You can find information about how to get Visual Studio and the WDK on the [WDK setup and download page](https://docs.microsoft.com/windows-hardware/drivers/download-the-wdk). The [Debugging Tools for Windows](https://docs.microsoft.com/windows-hardware/drivers/debugger/index) are included with the WDK installation.
