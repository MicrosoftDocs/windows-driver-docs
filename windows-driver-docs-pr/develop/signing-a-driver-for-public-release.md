...
1.  Use the [**Pvk2Pfx**](https://docs.microsoft.com/windows-hardware/drivers/devtest/pvk2pfx) tool to create a Personal Information Exchange (PFX) certificate. The **Pvk2Pfx** tool takes your PVK and SPC files as input and creates a single PFX file. For this exercise, assume that your PFX file is named MyCert.pfx.
...
* [Installing a Boot-Start Driver](https://docs.microsoft.com/windows-hardware/drivers/install/installing-a-boot-start-driver)
