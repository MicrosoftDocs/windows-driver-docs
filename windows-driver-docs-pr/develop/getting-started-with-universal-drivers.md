...
description: Universal Windows drivers allow you to create one driver that runs across multiple different device types, from embedded systems to tablets and desktop PCs.
