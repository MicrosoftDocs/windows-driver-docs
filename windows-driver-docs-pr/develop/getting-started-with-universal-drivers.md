...
*  In your [**INF DestinationDirs Section**](../install/inf-destinationdirs-section.md) set the destination directories to 13 to make the driver run from the Driver Store.  This will not work for some devices.
