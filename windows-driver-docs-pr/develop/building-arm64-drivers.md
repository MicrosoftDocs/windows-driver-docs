...
Windows 10 Desktop (Pro and S versions) can now run on machines that are powered by ARM64 Snapdragon processors.  However, because Windows 10 on ARM does not support x86 emulation of kernel-mode drivers, you must recompile kernel-mode drivers to ARM64 using the instructions below.

## Setup

1. Download [Visual Studio 2017](https://www.visualstudio.com/vs/preview/).  You'll need at minimum version 15.4.0 Preview 2.0.
...
4.	From **Type or Select new Platform**, select **ARM64**.  Copy settings from **x86**.  Click **OK** and **Close**.  
...
* [Windows 10 desktop on Snapdragon Processors](https://docs.microsoft.com/windows/uwp/porting/apps-on-snapdragon)
