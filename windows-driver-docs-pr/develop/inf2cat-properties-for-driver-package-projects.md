...
<td align="left"><p>Runs the [<strong>Inf2Cat</strong>](https://msdn.microsoft.com/Library/Windows/Hardware/Ff547089) tool on any INF files in the project (for example, .inf, .inx, or .inv files).</p></td>
</tr>
<tr class="even">
...
<p>This setting is equivalent to specifying the [<strong>Inf2Cat</strong>](https://msdn.microsoft.com/Library/Windows/Hardware/Ff547089) option <strong>/os:</strong><em>WindowsVersionList</em>.</p></td>
</tr>
<tr class="odd">
...
<p>This setting is equivalent to specifying the [<strong>Inf2Cat</strong>](https://msdn.microsoft.com/Library/Windows/Hardware/Ff547089) option <strong>/pageHashes[:</strong><em>file1</em><strong>][,</strong><em>file2</em><strong>]...]</strong>.</p></td>
</tr>
<tr class="even">
...
<p>This setting is equivalent to specifying the [<strong>Inf2Cat</strong>](https://msdn.microsoft.com/Library/Windows/Hardware/Ff547089) option <strong>/pe[:</strong><em>file1</em><strong>[,</strong><em>file2</em><strong>]...]</strong>.</p></td>
</tr>
<tr class="odd">
...
<p>This setting is equivalent to specifying the [<strong>Inf2Cat</strong>](https://msdn.microsoft.com/Library/Windows/Hardware/Ff547089) option <strong>/drm[:</strong><em>file1</em><strong>[,</strong><em>file2</em><strong>]...]</strong>.</p></td>
</tr>
<tr class="even">
...
<p>This setting is equivalent to specifying the [<strong>Inf2Cat</strong>](https://msdn.microsoft.com/Library/Windows/Hardware/Ff547089) option <strong>/verbose</strong>.</p></td>
</tr>
<tr class="odd">
...
<p>This setting is equivalent to specifying the [<strong>Inf2Cat</strong>](https://msdn.microsoft.com/Library/Windows/Hardware/Ff547089) option <strong>/nocat</strong>.</p></td>
</tr>
<tr class="even">
...
<td align="left"><p>Use the local time zone while verifying the [<strong>INF DriverVer Directive</strong>](https://msdn.microsoft.com/Library/Windows/Hardware/Ff547394) directive. By default UTC, is used.</p>
<p>This setting is equivalent to specifying the [<strong>Inf2Cat</strong>](https://msdn.microsoft.com/Library/Windows/Hardware/Ff547089) option <strong>/uselocaltime</strong>.</p></td>
</tr>
</tbody>
</table>
