...
<td align="left"><p>Runs the <a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/inf2cat" data-raw-source="[&lt;strong&gt;Inf2Cat&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/devtest/inf2cat)"><strong>Inf2Cat</strong></a> tool on any INF files in the project (for example, .inf, .inx, or .inv files).</p></td>
</tr>
<tr class="even">
...
<p>This setting is equivalent to specifying the <a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/inf2cat" data-raw-source="[&lt;strong&gt;Inf2Cat&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/devtest/inf2cat)"><strong>Inf2Cat</strong></a> option <strong>/verbose</strong>.</p></td>
</tr>
<tr class="odd">
...
<p>This setting is equivalent to specifying the <a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/inf2cat" data-raw-source="[&lt;strong&gt;Inf2Cat&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/devtest/inf2cat)"><strong>Inf2Cat</strong></a> option <strong>/nocat</strong>.</p></td>
</tr>
<tr class="even">
...
<td align="left"><p>Use the local time zone while verifying the <a href="https://docs.microsoft.com/windows-hardware/drivers/install/inf-driverver-directive" data-raw-source="[&lt;strong&gt;INF DriverVer Directive&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/install/inf-driverver-directive)"><strong>INF DriverVer Directive</strong></a> directive. By default UTC, is used.</p>
<p>This setting is equivalent to specifying the <a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/inf2cat" data-raw-source="[&lt;strong&gt;Inf2Cat&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/devtest/inf2cat)"><strong>Inf2Cat</strong></a> option <strong>/uselocaltime</strong>.</p></td>
</tr>
</tbody>
</table>
