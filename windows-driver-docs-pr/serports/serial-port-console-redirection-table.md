...
| Interface Type | 1 | 36 | Indicates the type of the register interface: <p> For Revision 1: </p> <ul><li>0 = full 16550 interface </li><li>1 = full 16450 interface (must also accept writing to the 16550 FCR register) </li><li>2-255 = reserved </li></ul><p>For Revision 2: <p>See the Serial Port Subtypes in Table 3 of the [DBG2 Specification](https://docs.microsoft.com/previous-versions/windows/hardware/design/dn639131(v=vs.85)) </p>| 
