...
- See [Serial Device Control Requests](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/index) for detailed descriptions of all the serial IOCTLs that are defined by the Windows serial I/O request interface.
