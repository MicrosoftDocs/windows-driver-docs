...
> [!Note]
> During installation you will see the Visual Studio installer install the WDK Visual Studio Extensions.  See [Download the Windows Driver Kit](./download-the-wdk.md#download-icon-for-wdk-step-3-install-wdk) for additional information.
