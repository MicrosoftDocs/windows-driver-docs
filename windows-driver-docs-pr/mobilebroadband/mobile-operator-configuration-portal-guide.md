...
9. Verify your email, then enter a new non-temporary password and select **Create**. This is your login password going forward.

## Introduction to COSA

COSA is made up of the following:

- Targets: These are the network / SIM identifiers Windows will use to match COSA
  settings to a device.
- One SIM setting: These are settings Windows uses to change the experience such as branding, icons, and
  account management.
- One or more connections: These are settings that specify how the device will connect to the network. This
...
2. Select **New draft**.
3. Fill our the fields labeled **Title**, **Description**, and **Background**. To the best of your knowledge at this time. You will have an opportunity to update these fields again before submitting.

## Modifying a draft

Now that you’ve created a new draft you can start editing. Select the draft you’d like to modify. On the right side of the page, the draft metadata will be populated. Here, you can modify the drafts **Description** and **Background** fields. When you’re ready to make changes to COSA, select **Open draft** . This will bring you to the COSA editing page.
...
Selecting a profile from the left menu will open that profile for editing. The menu on the left will show the different types of settings available to be edited.
...
1. Add a new connection and set it's APN.
...
Start by clicking on the **submit** button at the bottom of your draft. Remember, Microsoft will not test your
...
tested. If you are *not* an MO, confirm that you have written approval from the MO to make changes to their COSA settings and approval of the specific changes.
...
Active submissions are in the **Pending** state. Once a submission is reviewed, it’s state will be updated to either **Accepted** or **Rejected** and will be moved to the previous submissions table.

Selecting an active submission will show the submission metadata on the right side of the page. Active submissions can be modified or discarded before being reviewed. You can modify an active submission by
...
During review, the COSA review team may choose to send a message back to the submitter through the MOCP. Submissions with comments from the review team will have a red exclamation mark next to them. Selecting a
