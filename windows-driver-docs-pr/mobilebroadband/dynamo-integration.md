---
title: DYNAMO integration
description: This topic describes the integration step for the DYNAMO program.
ms.assetid: 6857A67A-D33E-479C-B61D-332FDFE8A776
keywords:
- Windows DYNAMO integration, DYNAMO integration mobile operators
...
This topic details the work that is needed to integrate the mobile operator backend and Microsoft systems together to enable DYNAMO. Once this is complete, the integration will be at the ready-for-production checkpoint.
