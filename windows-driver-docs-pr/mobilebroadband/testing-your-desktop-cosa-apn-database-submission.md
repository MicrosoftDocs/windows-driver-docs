...
These steps require a script from Microsoft to apply and test the PPKG file. [Download the latest version of the script](https://dev.azure.com/microsoft/OS/_git/os.2020?path=/onecoreuap/admin/prov/tools/Scripts/ApplyCosaProvisioning.BAT&version=GBofficial/main).
