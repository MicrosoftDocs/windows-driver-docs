...
| Group | Setting name | Description | Optional or required | Notes |
| --- | --- | --- | --- | --- |
| BrandingInformation | BrandingFlags | A string that modifies the branding string and logo, if available, in the calling experience. | | |
| PhoneSettings | AssistedDialSetting | The default state for international assist. | | |
