...
For more info about the USSD API, see [**Windows.Networking.NetworkOperators namespace**](https://docs.microsoft.com/uwp/api/Windows.Networking.NetworkOperators).
