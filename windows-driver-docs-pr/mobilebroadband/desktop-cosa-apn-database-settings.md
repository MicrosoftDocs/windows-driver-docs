...
| DataMarketplaceRoamingUIEnabled | This setting controls whether the roaming UI should be shown for a (e)SIM that it is part of Mobile Plans service. | Optional | This setting works with **SupportDataMarketPlace** setting. The possible values are: <ul><li>0: The roaming indicator will **never** be displayed.</li><li>1: The roaming indicator will shown when the device is roaming in a foreign country.</li></ul> <p>If left blank, defaults to 1</p> | Windows 10, version 1709 |
