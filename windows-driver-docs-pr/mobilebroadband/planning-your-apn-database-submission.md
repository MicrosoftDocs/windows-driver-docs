...
| APN database & COSA | IP Type | A string specifying the network protocol of the connection. Available values are: <ul><li>IPv4</li><li>IPv6</li><li>IPv4v6</li></ul> | Optional | If left blank, defaults to "IPv4." |
