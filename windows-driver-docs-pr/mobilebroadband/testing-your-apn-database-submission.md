...
**Note**  At this time, the test submission process for the COSA feature in the next major update to Windows 10 is as described in the section "Submitting the APN database update".
