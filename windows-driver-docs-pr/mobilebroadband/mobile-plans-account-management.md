...
- Launch the Mobile Plans app and open the mobile operator web portal.
 ...
 Once you have decided on one of these options, please request a COSA database update to implement the right behavior. For more info, please see [Planning your desktop COSA/APN database submission](planning-your-desktop-planning-your-desktop-cosa-apn-database-submission.md).
