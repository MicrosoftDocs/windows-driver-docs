...
If the ownership of an IMSI changes, go to [Partner Center dashboard technical support](/windows-hardware/drivers/dashboard/hardware-submission-update) and supply the following info:
