...
The Windows device ID for the network adapter is exposed by the [**DeviceId**](https://msdn.microsoft.com/library/windows/apps/br207365) property of the current network device object for the account.
