...
This topic provides information about the Mobile Operator Notification system event for Windows 8, Windows 8.1, and Windows 10. It provides guidelines for you to develop UWP mobile broadband apps that handle incoming SMS- or USSD-based mobile operator notifications and relevant mobile broadband system events.
