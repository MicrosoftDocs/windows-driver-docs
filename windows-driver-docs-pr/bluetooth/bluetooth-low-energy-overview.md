...
In addition to the standard [Bluetooth Profile Driver functions](/windows-hardware/drivers/ddi/index), Windows 8 introduces new [Bluetooth Low Energy functions](/windows-hardware/drivers/ddi//_bltooth/#functions) which allows for the development of Bluetooth GATT client applications.
