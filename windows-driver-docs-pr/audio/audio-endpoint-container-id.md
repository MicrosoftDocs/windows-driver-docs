...
For more information about container IDs and about the algorithm mentioned in the preceding section, see [Container ID](https://docs.microsoft.com/windows-hardware/drivers/install/container-ids) and [Audio Endpoint Builder Algorithm](audio-endpoint-builder-algorithm.md).
