...
MS-HAID: 'audio.examples\_of\_audio\_data\_formats\_and\_data\_ranges'
...
The following examples show how to use the [**KSDATAFORMAT**](stream.ksdataformat) and [**KSDATARANGE**](stream.ksdatarange) structures to describe some of the more common formats for audio streams:
