...
-   They can playback or record wave data (audio data that is described by a [**WAVEFORMATEX**](/windows/win32/api/mmreg/ns-mmreg-twaveformatex) or [**WAVEFORMATEXTENSIBLE**](/windows-hardware/drivers/ddi/ksmedia/ns-ksmedia-waveformatextensible) structure).
