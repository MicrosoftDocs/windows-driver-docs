...
MS-HAID: 'audio.directsound\_stream\_data\_format'
...
This example uses a [**KSDATAFORMAT\_DSOUND**](audio.ksdataformat_dsound) structure to describe the data format of a DirectSound stream.
