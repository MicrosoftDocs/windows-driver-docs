...
This property key is identical to the [PKEY\_FX\_StreamEffectClsid](pkey-fx-streameffectclsid.md) property key, but it is a composite that uses VT_LPWSTR to allow multiple effects in a single position.  
...
```inf
[Strings]
PKEY_CompositeFX_StreamEffectClsid   = "{D04E05A6-594B-4fb6-A80D-01AF5EED7D1D},5"
...
; Driver developers should replace this CLSIDs with that of their own APO
FX_STREAM_CLSID      = "{00000000-0000-0000-0000-000000000000}"
...
[SWAPAPO.AddReg]
HKR,"FX\\0",%PKEY_CompositeFX_StreamEffectClsid%,,%FX_STREAM_CLSID%
```
