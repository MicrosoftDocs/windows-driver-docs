...
This property key is identical to the [PKEY\_FX\_KeywordDetector\_StreamEffectClsid](pkey-fx-keyworddetector-streameffectclsid.md) property key, but it is a composite that uses VT_LPWSTR to allow multiple effects in a single position.  
...
...
[SWAPAPO.AddReg]
HKR,"FX\\0",%PKEY_CompositeFX_KeywordDetector_StreamEffectClsid%,,%FX_KEYWORD_STREAM_CLSID%
```
