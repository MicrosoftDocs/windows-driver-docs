...
MS-HAID: 'audio.directmusic\_stream\_data\_format'
...
This example uses a [**KSDATAFORMAT**](stream.ksdataformat) structure to describe the data format of a DirectMusic stream.
