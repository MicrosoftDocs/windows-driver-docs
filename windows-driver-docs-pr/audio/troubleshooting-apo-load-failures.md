---
title: Troubleshooting APO Load Failures
description: Troubleshooting APO Load Failures
...
Also, if the failure count value for an LFX or a GFX APO reaches a system-specified limit, both the LFX and the GFX APOs are disabled by setting the PKEY\_Endpoint\_Disable\_SysFx registry key to '1'. The system-specified limit is currently a value of 10.
