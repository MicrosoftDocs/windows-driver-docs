...
A miniport driver stores information about each property that it supports in a [**PCPROPERTY\_ITEM**](https://docs.microsoft.com/windows-hardware/drivers/ddi/portcls/ns-portcls-pcproperty_item) structure. This structure contains the following information about the property:
