...
keywords: ["non-PCM audio formats WDK , Windows 98"]
---
...
The [IPortClsVersion](https://msdn.microsoft.com/library/windows/hardware/ff536877) interface is not available in this hotfix, which means that this interface cannot be used to detect the presence of the hotfix.
