...
A peakmeter node should provide a property handler for the property flags (see [**KSPROPERTY**](/windows-hardware/drivers/stream/ksproperty-structure)) that appear in the following table.
