...
The following table lists legacy WDK releases, their corresponding SDK and Visual Studio versions. Some of these releases contain components affected by [CVE-2024-29187](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-29187) and are **NOT safe for production driver development**. They are provided only for reference and non-production use
...
| Windows Server 2022 (FE) | 20348.1| VS 2019 | [SDK (*)](https://go.microsoft.com/fwlink/?linkid=2164145) | [WDK (*)](https://go.microsoft.com/fwlink/?linkid=2164149) | [EWDK](https://go.microsoft.com/fwlink/?linkid=2163981) | N/A |  
