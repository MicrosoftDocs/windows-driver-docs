...
The following table lists legacy and unsupported WDK versions, their corresponding SDK and Visual Studio versions where available. If you are developing a driver for the Windows platform, use one of the supported kits listed on the [supported WDK versions](./other-wdk-downloads.md) table.
