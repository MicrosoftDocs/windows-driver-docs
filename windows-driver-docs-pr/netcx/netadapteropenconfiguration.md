...
If the client provides a [**WDF\_OBJECT\_ATTRIBUTES**](wdf-wdf_object_attributes), it specifies **NULL** for **ParentObject**. The adapter configuration object is automatically parented to the adapter object.
