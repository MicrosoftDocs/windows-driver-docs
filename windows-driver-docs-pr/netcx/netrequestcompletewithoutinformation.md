...
Remarks
-----
Typically, the client driver calls **NetRequestCompleteWithoutInformation** from one of its control request handler routines. The client driver should call this function when completing a request that doesn't require additional memory transfer. For more info, see [Handling Control Requests](handling-control-requests.md#completing-requests).
