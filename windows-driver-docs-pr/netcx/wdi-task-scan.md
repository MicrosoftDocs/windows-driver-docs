---
title: WDI_TASK_SCAN
description: WDI_TASK_SCAN requests a survey of BSS networks. The port performs a scan according to the requirements of the IEEE 802.11 specification.
ms.date: 06/30/2021
keywords:
 - WDI_TASK_SCAN Network Drivers Starting with Windows Vista
...
WDI_TASK_SCAN requests a survey of BSS networks. The port performs a scan according to the requirements of the IEEE 802.11 specification.
