---
title: WDI_TLV_FTM_RESPONSE (dot11wificxtypes.hpp)
...
| [WDI_TLV_FTM_BANDWIDTH_USED](wdi-tlv-ftm-bandwidth-used.md) | [**WDI_FTM_BANDWIDTH**](/windows-hardware/drivers/ddi/dot11wificxtypes/ne-dot11wificxtypes-wdi_ftm_bandwidth) |   |   | The negotiated bandwidth in MHz between the two STAs to exercise the FTM. If the FTM response status was successful, this field is mandatory. |
...
| [WDI_TLV_FTM_PROPAGATION_PROPERTY](wdi-tlv-rtt.md) | [**WDI_FTM_PROPAGATION**](/windows-hardware/drivers/ddi/dot11wificxtypes/ne-dot11wificxtypes-wdi_ftm_propagation) |   |  X | This field is used when the LE has logic to estimate properties about the propagation of the signal. It's okay if only certain values can be provided. |
| [WDI_TLV_LCI_REPORT_STATUS](wdi-tlv-lci-report-status.md) | [**WDI_LCI_REPORT_STATUS**](/windows-hardware/drivers/ddi/dot11wificxtypes/ne-dot11wificxtypes-wdi_lci_report_status) |   |   | If an LCI report was requested, this field provides the status result. If successful, the following fields are present and mandatory. |
