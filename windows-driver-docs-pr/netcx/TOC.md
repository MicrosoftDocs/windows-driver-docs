...
## [Porting NDIS miniport drivers to the NetAdapter Class Extension](porting-ndis-to-netadapter-cx.md)
...
## [Power-up sequence for a Network Adapter WDF client driver](power-up-sequence-for-ndis-wdf-client-driver.md)
## [Power-down sequence for a Network Adapter WDF client driver](power-down-sequence-for-ndis-wdf-client-driver.md)
