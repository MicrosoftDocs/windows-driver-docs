...
After it has called [**WdfDeviceCreate**](wdf-wdfdevicecreate), the client typically calls **NetAdapterCreate** from within its [*EvtDriverDeviceAdd*](wdf-evtdriverdeviceadd) routine.
