---
title: WDI_TLV_PM_PROTOCOL_OFFLOAD_IPv4ARP (dot11wificxtypes.hpp)
ms.topic: reference
description: WDI_TLV_PM_PROTOCOL_OFFLOAD_IPv4ARP is a WiFiCx TLV that contains IPv4 ARP protocol offload parameters.
ms.date: 08/25/2023
keywords:
 - WDI_TLV_PM_PROTOCOL_OFFLOAD_IPv4ARP Network Drivers Starting with Windows Vista
---

# WDI\_TLV\_PM\_PROTOCOL\_OFFLOAD\_IPv4ARP (dot11wificxtypes.hpp)
