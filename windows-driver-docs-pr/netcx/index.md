...
Starting in the next major update to Windows 10, the Windows Driver Kit (WDK) includes a class extension module (NetAdapterCx) that enables you to write a KMDF-based driver for a network adapter.
