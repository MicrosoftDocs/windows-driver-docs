---
title: WiFiCx TLV generator/parser XML semantics
description: The WiFiCx generator/parser XML file is a list of messages, containers (TLVs), and property groups (structs). This topic covers the XML syntax.
ms.date: 09/10/2021
ms.localizationpriority: medium
---

# WiFiCx TLV generator/parser XML semantics
...
- `commandId` - Symbolic constant that must be defined in dot11wificxintf.h.
