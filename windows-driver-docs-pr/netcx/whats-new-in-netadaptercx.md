...
| --- | --- | --- |
| Windows 10, version 1703 | 1.0 | Initial release, preview only |
| Windows 10, version 1709 | 1.1 | Preview only |
| Windows 10, version 1803 | 1.2 | Preview only |

> [!IMPORTANT]
> NetAdapterCx client drivers written in previous versions will not work in the latest version of Windows until they are retargeted to the current version. For more info, see the Introduction page for the current version. As of Windows 10, version 1803, the current version of NetAdapterCx is **1.2**. 
