...
| Method | Request URI |
|:--|:--|
| POST | https://manage.devcenter.microsoft.com/v1.0/hardware/products/{productID}/submissions/{submissionID}/commit |
...
```
POST https://manage.devcenter.microsoft.com/v1.0/hardware/products/14631253285588838/submissions/1152921504621465124/commit HTTP/1.1
