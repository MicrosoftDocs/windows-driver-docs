...
|Method|Request URI|
|:--|:--|
|GET|`https://manage.devcenter.microsoft.com/v1.0/hardware/products/{productID}/submissions/{submissionID}` |
...
```
GET https://manage.devcenter.microsoft.com/v1.0/hardware/products/13635057453741329/submissions/1152921504621441930 HTTP/1.1
