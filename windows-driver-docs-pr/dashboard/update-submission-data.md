...
| Method | Request URI |
|:--|:--|
| PATCH | `https://manage.devcenter.microsoft.com/v1.0/hardware/products/{productID}/submissions/{submissionId}`
...
```json 
PATCH https://manage.devcenter.microsoft.com/v1.0/hardware/products/14631253285588838/submissions/1152921504627422408 HTTP/1.1
