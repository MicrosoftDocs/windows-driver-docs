...
| Shipping Label Owner           | Can create and manage shipping labels, and can submit shipping labels that do not have driver promotions (automatic installation) selected. Can submit shipping labels that have driver promotions(automatic installation) selected.                                             |
