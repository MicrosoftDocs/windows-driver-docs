...
DRM (Digital Rights Management) techniques (Software or Hardware) are used during Video Playback on windows devices. We use the set of all devices with SWDRM playback as our sample place to compute the percentage. More information about DRM can be found at [Digital Rights Management - Windows drivers | Microsoft Docs](https://learn.microsoft.com/en-us/windows-hardware/drivers/audio/digital-rights-management).
