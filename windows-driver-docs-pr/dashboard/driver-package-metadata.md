...
If you are the publisher and received the submission via sharing you may need to run the [Create Publisher Metadata](create-publisher-metadata.md) method to generate the driver metadata for that submission.
