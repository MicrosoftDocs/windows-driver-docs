...
>
> If the update includes a KB article number, search for that number on the [Microsoft support](https://support.microsoft.com/) web site to find more information.
>
> If the update was for a non-Microsoft driver, go to the web site for the hardware vendor to find more information.
>
> If you're looking for technical support for the dashboard or Windows Hardware Lab Kit (HLK), please read on.

If your issue is technical and you can't find answers in the documentation, contact Windows developer support.
