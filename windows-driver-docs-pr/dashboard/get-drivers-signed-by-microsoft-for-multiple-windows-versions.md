...
This is a [recent change in policy](https://blogs.msdn.microsoft.com/windows_hardware_certification/2015/10/20/update-on-sysdev-ev-certificate-requirement/). If you have an EV cert bound to the account for your organization, you’re good to go – that is, you can continue to use a standard SHA-2 certificate when you submit your package.
