...
<tbody>
<tr class="odd">
<td align="left"><p><strong>*DiffFontsPerByteMode?</strong></p></td>
<td align="left"><p><strong>TRUE</strong> or <strong>FALSE</strong>. For printers supporting both single-byte and double-byte modes, this indicates whether the printer maintains separate fonts and font characteristics for each mode.</p></td>
