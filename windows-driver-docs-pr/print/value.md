...
<td align="left"><p>The XPath query that the WSD monitor will apply to the XML document that is specified by the query. See the discussion later in this topic.</p></td>
</tr>
<tr class="odd">
...
<td align="left"><p>The type of query that the WSD monitor will perform.</p></td>
</tr>
<tr class="odd">
