---
title: IBidiRequestContainer IBidiRequestContainer GetEnumObject method
...
keywords: ["IBidiRequestContainer GetEnumObject method Print Devices", "IBidiRequestContainer GetEnumObject method Print Devices , IBidiRequestContainer interface", "IBidiRequestContainer interface Print Devices , IBidiRequestContainer GetEnumObject method"]
topic_type:
- apiref
api_name:
...
# IBidiRequestContainer::IBidiRequestContainer::GetEnumObject method


The **IBidiRequestContainer::GetEnumObject** method enumerates the bidi requests in a list.
...
*ppenum* \[out\]  
Pointer to the variable that receives a pointer to the [**IEnumUnknown**](_com_ienumunknown) interface that enumerates the bidi requests in the container.
...
An application can call [**IEnumUnknown::Next**](_com_ienumunknown_next) to retrieve one or more [**IBidiRequest**](ibidirequest.md) interfaces.
