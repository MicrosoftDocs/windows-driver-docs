...
1.  Follow the Microsoft [bidi communications schema](bidi-communications-schema-reference.md) and the [bidi communication interfaces](bidirectional-communication-interfaces.md) described in the Windows SDK documentation.
