# [Print Devices](portal.md)
## [Print Devices Design Guide](print-devices-design-guide.md)
...
######## [ConvertPrintTicketToDevMode](convertprinttickettodevmode2.md)
######## [ValidatePrintTicket](validateprintticket2.md)
...
######### [GetResult](ibidirequest-ibidirequest--getresult.md)
######### [SetInputData](ibidirequest-ibidirequest--setinputdata.md)
######### [SetSchema](ibidirequest-ibidirequest--setschema.md)
######## [IBidiRequestContainer](ibidirequestcontainer.md)
######### [AddRequest](ibidirequestcontainer-ibidirequestcontainer--addrequest.md)
######### [GetEnumObject](ibidirequestcontainer-ibidirequestcontainer--getenumobject.md)
######### [GetRequestCount](ibidirequestcontainer-ibidirequestcontainer--getrequestcount.md)
######## [IBidiSpl](ibidispl.md)
######### [BindDevice](ibidispl-ibidispl--binddevice.md)
######### [MultiSendRecv](ibidispl-ibidispl--multisendrecv.md)
######### [SendRecv](ibidispl-ibidispl--sendrecv.md)
######### [UnbindDevice](ibidispl-ibidispl--unbinddevice.md)
######## [IBidiSpl2](ibidispl2.md)
######### [BindDevice](ibidispl2-ibidispl2--binddevice.md)
######### [SendRecvXMLStream](ibidispl2-ibidispl2--sendrecvxmlstream.md)
######### [SendRecvXMLString](ibidispl2-ibidispl2--sendrecvxmlstring.md)
######### [UnbindDevice](ibidispl2-ibidispl2--unbinddevice.md)
######## [Bidi Error Codes](bidi-error-codes.md)
...
######## [Bidi Communications Schema Reference](bidi-communications-schema-reference.md)
...
### [HP ENVY e-All-in-One printers on Windows 10](hp-envy-7540-driver-and-software-on-windows-10.md)
