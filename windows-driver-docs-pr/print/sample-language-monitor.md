...
For Windows 7, sample source code for Pjlmon.dll is included with the [Windows Driver Kit Version 7.1.0](https://www.microsoft.com/en-us/download/details.aspx?id=11800) installation download. The sample is located in the **\\src\\print\\monitors\\pjlmon** subdirectory (for example, C:\WinDDK\7600.16385.1\src\print\monitors\pjlmon).
