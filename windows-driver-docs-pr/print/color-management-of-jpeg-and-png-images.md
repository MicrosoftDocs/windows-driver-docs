...
For more information about supporting JPEG and PNG compressed images, see the Remarks section for [**DEVINFO**](https://docs.microsoft.com/windows/win32/api/winddi/ns-winddi-tagdevinfo).
