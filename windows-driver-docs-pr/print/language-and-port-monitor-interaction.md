...
Most of the functions defined by print monitors commands to the data stream and then calls the port monitor's **WritePort** to send the stream to the port driver.
