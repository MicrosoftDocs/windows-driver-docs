...
To get started, be sure you have [Microsoft Visual Studio](../download-the-wdk#download-and-install-the-windows-11-version-22h2-wdk.md), the [Windows SDK](https://developer.microsoft.com/windows/downloads/windows-10-sdk), and the [Windows Driver Kit (WDK)](../download-the-wdk.md) installed.
