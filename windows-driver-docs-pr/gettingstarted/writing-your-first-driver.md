...
<td align="left"><p>This topic describes how to write a <a href="https://msdn.microsoft.com/windows-drivers/develop/getting_started_with_universal_drivers" data-raw-source="[Universal Windows driver](https://msdn.microsoft.com/windows-drivers/develop/getting_started_with_universal_drivers)">Universal Windows driver</a> using User-Mode Driver Framework (UMDF) 2. You&#39;ll start with a Microsoft Visual Studio template and then deploy and install your driver on a separate computer.</p></td>
</tr>
<tr class="even">
...
<td align="left"><p>This topic describes how to write a <a href="https://msdn.microsoft.com/windows-drivers/develop/getting_started_with_universal_drivers" data-raw-source="[Universal Windows driver](https://msdn.microsoft.com/windows-drivers/develop/getting_started_with_universal_drivers)">Universal Windows driver</a> using Kernel-Mode Driver Framework (KMDF). You&#39;ll start with a Visual Studio template and then deploy and install your driver on a separate computer.</p></td>
</tr>
<tr class="odd">
...
<td align="left"><p>This topic describes how to write a <a href="https://msdn.microsoft.com/windows-drivers/develop/getting_started_with_universal_drivers" data-raw-source="[Universal Windows driver](https://msdn.microsoft.com/windows-drivers/develop/getting_started_with_universal_drivers)">Universal Windows driver</a> using KMDF. You&#39;ll start with a Visual Studio template and then deploy and install your driver on a separate computer.</p></td>
</tr>
</tbody>
</table>
