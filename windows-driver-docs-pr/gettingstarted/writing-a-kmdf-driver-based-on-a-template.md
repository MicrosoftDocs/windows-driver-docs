...
To get started, be sure you have the latest versions of [Microsoft Visual Studio](../download-the-wdk.md#download-and-install-the-windows-11-version-23h2-wdk) and the [Windows Driver Kit (WDK)](../download-the-wdk.md) installed.
