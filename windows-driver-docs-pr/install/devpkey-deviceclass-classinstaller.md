...
The DEVPKEY_DeviceClass_ClassInstaller device property represents the class installer for a [device setup class](https://docs.microsoft.com/windows-hardware/drivers/install/device-setup-classes).
