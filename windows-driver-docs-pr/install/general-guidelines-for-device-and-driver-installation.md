...
-   Use one of the [System-Defined Device Setup Classes](https://docs.microsoft.com/previous-versions/ff553419(v=vs.85)). Do not define your own setup class unless there is a compelling reason to do so.
