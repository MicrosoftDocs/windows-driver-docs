...
The DEVPKEY_DeviceClass_DevType device property represents the default device type for a [device setup class](https://docs.microsoft.com/windows-hardware/drivers/install/device-setup-classes).
