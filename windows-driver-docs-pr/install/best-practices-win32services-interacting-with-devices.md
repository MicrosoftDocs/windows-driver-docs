...
To install the service, use the [INF AddService](https://docs.microsoft.com/en-us/windows-hardware/drivers/install/inf-addservice-directive) directive.  This will allow you to create and start the service.
...
Once you have found the desired device interface, open a handle to the interface via [CreateFile](https://docs.microsoft.com/en-us/windows/desktop/api/fileapi/nf-fileapi-createfilea).  
...
Additionally, you can find useful documentation regarding **AddTrigger** on the [AddService](https://docs.microsoft.com/en-us/windows-hardware/drivers/install/inf-addservice-directive) page.
