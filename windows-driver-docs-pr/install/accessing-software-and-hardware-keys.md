...
This section provides guidelines that the components of a driver package and *software keys* for a device. These guidelines are discussed in the following topics:
