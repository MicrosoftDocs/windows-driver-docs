...
The GUID_DEVINTERFACE_NET [device interface class](./overview-of-device-interface-classes.md) is defined for [network devices](/windows-hardware/drivers/network/)).
...
For information about network devices and drivers, see [Network Design Guide](/windows-hardware/drivers/network/)).
