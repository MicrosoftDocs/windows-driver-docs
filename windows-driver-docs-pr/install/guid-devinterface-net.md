...
The GUID_DEVINTERFACE_NET [device interface class](./overview-of-device-interface-classes.md) is defined for [network devices](/windows-hardware/network/).
...
For information about network devices and drivers, see [Network Design Guide](/windows-hardware/network/).
