...
GUID_CLASS_INPUT is an obsolete identifier for the [device interface class](https://docs.microsoft.com/windows-hardware/drivers/install/device-interface-classes) for [HID collections](https://msdn.microsoft.com/windows/hardware/drivers/hid/hid-collections). Starting with Microsoft Windows 2000, use the [**GUID_DEVINTERFACE_HID**](guid-devinterface-hid.md) class identifier for new instances of this class.
