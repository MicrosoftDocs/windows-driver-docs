...
**0x00040000** (SPSVCINST_NOCLOBBER_BOOTFLAGS) (Windows 11 build 25398 and later versions of Windows)
...
[BootFlags=value] (Windows 11 build 25398 and later versions of Windows)
```
...
> [!NOTE]
> This value can only be used with kernel-mode driver services and is only available with Windows 11 build 25398 and above.
...
> [!NOTE]
> This syntax should be used only in Windows versions and builds older than Windows 11 build 25398; for Windows 11 build 25398 and later, use the **BootFlags** directive.
