...
When the reboot directive is specified, the caller will be notified that a system reboot is required to complete the installation of any devices using this INF install section. When the installation has been initiated through a function such as [**UpdateDriverForPlugAndPlayDevices**](/windows/desktop/api/newdev/nf-newdev-updatedriverforplugandplaydevicesa), [**DiInstallDriver**](/windows/desktop/api/newdev/nf-newdev-diinstalldrivera), or [**DiInstallDevice**](/windows/desktop/api/newdev/nf-newdev-diinstalldevice), this will result in the *NeedReboot* out parameter of these routines being set to TRUE.
