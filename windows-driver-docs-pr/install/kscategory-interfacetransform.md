---
title: KSCATEGORY\_INTERFACETRANSFORM
description: KSCATEGORY\_INTERFACETRANSFORM
...
The KSCATEGORY\_INTERFACETRANSFORM [device interface class](https://msdn.microsoft.com/library/windows/hardware/ff541339) is defined for the [kernel streaming](https://msdn.microsoft.com/library/windows/hardware/ff568277) (KS) functional category that transforms the interface of a device.
...
The KSCATEGORY\_INTERFACETRANSFORM functional category is one of the [**KSPROPERTY\_TOPOLOGY\_CATEGORIES**](https://msdn.microsoft.com/library/windows/hardware/ff565799) functional categories.
