...
If a [system-provided device installation component](/windows-hardware/drivers/install/overview-of-device-and-driver-installation) sends this DIF request to retrieve a list of the files associated with a device, the component retrieves the file queue but does not commit the queue.
