...
If the [Hardware Certification Kit (HCK)](/previous-versions/windows/hardware/hck/jj124227(v=vs.85)) does not have a [test category](/windows-hardware/test/hlk/) for your device type, in order to [release-sign](/windows-hardware/drivers/install/deprecation-of-software-publisher-certificates-and-commercial-release-certificates) your driver packages on Windows Vista and later versions of Windows, you must meet the following requirements:
