---
title: DEVPROP\_TYPE\_BYTE
description: In Windows Vista and later versions of Windows, the DEVPROP\_TYPE\_BYTE identifier represents the base-data-type identifier that indicates the data type is a BYTE-typed unsigned integer.
...
DEVPROP\_TYPE\_BYTE can be combined only with the [**DEVPROP\_TYPEMOD\_ARRAY**](devprop-typemod-array.md) property-data-type modifier.

### Setting a Property of this Type

To set a property whose data type is DEVPROP\_TYPE\_BYTE, call the corresponding SetupDiSet*Xxx* property function, setting the function input parameters as follows:
