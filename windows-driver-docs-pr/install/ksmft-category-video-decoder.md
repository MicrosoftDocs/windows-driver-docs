...
The KSMFT_CATEGORY_VIDEO_DECODER [device interface class](https://docs.microsoft.com/windows-hardware/drivers/install/device-interface-classes) is defined for the [Kernel Streaming](https://docs.microsoft.com/windows-hardware/drivers/stream/kernel-streaming) (KS) functional category for a video device.
