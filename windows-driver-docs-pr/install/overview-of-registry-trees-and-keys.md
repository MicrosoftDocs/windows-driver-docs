...
For information on accessing registry keys from WDF (KMDF or UMDF) drivers visit [Introduction to registry keys for WDF drivers](../wdf/introduction-to-registry-keys-for-drivers.md).
