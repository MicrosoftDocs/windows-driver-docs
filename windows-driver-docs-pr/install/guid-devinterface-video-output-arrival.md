...
The GUID_DEVINTERFACE_VIDEO_OUTPUT_ARRIVAL [device interface class](./overview-of-device-interface-classes.md) is defined for child devices of [display devices](../display/index.md).
