...
|Software components|Device add-on software is an MSI or EXE binary.  Allowed in [Universal Windows drivers](../develop/windows-10-editions-for-universal-drivers.md) but referenced binary only runs on Desktop. |
