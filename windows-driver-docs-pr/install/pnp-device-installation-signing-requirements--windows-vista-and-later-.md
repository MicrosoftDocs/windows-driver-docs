...
The [Windows Hardware Lab Kit (Windows HLK)](https://docs.microsoft.com/en-us/windows-hardware/test/hlk/windows-hardware-lab-kit) has [test categories](https://docs.microsoft.com/en-us/windows-hardware/test/hlk/testref/hardware-lab-kit-test-reference) for a variety of device types. If a test category for the device type is included in this list, you should obtain a [WHQL release signature](whql-release-signature.md).
