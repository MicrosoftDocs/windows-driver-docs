...
-   Handle one or more of the [device installation function codes](https://docs.microsoft.com/previous-versions/ff541307(v=vs.85)) (DIF codes) received by the [co-installer entry point](co-installer-interface.md#co-installer-entry-point) function.
...
-   Starting with Windows Vista, provide [finish-install actions](finish-install-actions--windows-vista-and-later-.md) (in response to a [**DIF_FINISHINSTALL_ACTION**](https://docs.microsoft.com/windows-hardware/drivers/install/dif-finishinstall-action) request) to install applications.
