...
**Note: If the AddSoftware directive being called is of Type 2, there is no need for a neither a Component INF nor an Extension INF, the directive can be called from any INF succesfully.  For an AddSoftware directive of Type 1, a Component INF that is called from an Extension INF is needed.**
