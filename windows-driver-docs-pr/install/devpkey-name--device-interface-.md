---
title: DEVPKEY\_NAME (Device Interface)
description: DEVPKEY\_NAME (Device Interface)
...
The value of DEVPKEY\_NAME is the same as the value of the [**DEVPKEY\_DeviceInterface\_FriendlyName**](devpkey-deviceinterface-friendlyname.md) device property, if DEVPKEY\_DeviceInterface\_FriendlyName is set. Otherwise, DEVPKEY\_NAME does not exist.

You can retrieve the value of DEVPKEY\_NAME by calling [**SetupDiGetDeviceInterfaceProperty**](https://msdn.microsoft.com/library/windows/hardware/ff551122).
...
[**DEVPKEY\_DeviceInterface\_FriendlyName**](devpkey-deviceinterface-friendlyname.md)
