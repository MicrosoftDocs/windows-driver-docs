...
> [!CAUTION]
> Starting in Windows 11 version 22H2, a [driver package](../install/driver-packages.md) using this directive will no longer be able to receive a signature from [Hardware Developer Center](../dashboard/index.yml).
>
