...
> [!NOTE]
> The **Desktop development with C++** workload selected above does not install the Windows SDK 10.0.26100.1.
...
1. When you're done with the build environment, you may want to eject the ISO.
