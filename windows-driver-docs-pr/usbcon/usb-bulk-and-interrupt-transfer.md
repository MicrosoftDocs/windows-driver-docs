...
1. Get, format, and send a framework request object to the USB driver stack.
1. Implement a completion routine to get notified when the USB driver stack completes the request.
