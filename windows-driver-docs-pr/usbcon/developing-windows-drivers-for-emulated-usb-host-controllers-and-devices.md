...
<p>[Emulated USB host controller driver programming reference](https://docs.microsoft.com/en-us/windows-hardware/drivers/ddi/content/_usbref/#emulated-host-controller-driver-reference)</p>
