...
2.  Construct a setup packet in a caller-allocated [**WINUSB\_SETUP\_PACKET**](/windows/win32/api/winusb/ns-winusb-_winusb_setup_packet) structure. Initialize the members to represent the request type and data as follows:
