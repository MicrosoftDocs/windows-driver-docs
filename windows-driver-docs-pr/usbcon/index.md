...
Windows operating systems include native support for USB host controllers, hubs, and devices and systems that comply with the official USB specification. Windows also provides programming interfaces that you can use to develop [device drivers](buses.usb_driver_development_guide) and [applications](buses.developing_windows_applications_that_communicate_with_a_usb_device) that communicate with a USB device.

[![usb for device builders](images/icon-dev.png)](buses.building_usb_devices_for_windows)[![usb for driver developers](images/icon-driver.png)](buses.usb_driver_development_guide)[![usb for app developers](images/icon-app.png)](buses.developing_windows_applications_that_communicate_with_a_usb_device)[![usb hck certification](images/icon-cert.png)](buses.windows_hardware_certification_kit_tests_for_usb)
...
<p></p>
[Windows 10: What's new for USB](buses.windows_10__what_s_new_for_usb)
<p>Overview of new features and improvements in USB in Windows 10.</p>
[USB FAQ](buses.usb_faq__introductory_level)
<p>Frequently asked questions from driver developers about the USB stack and features that are supported in USB.</p>
[Microsoft OS Descriptors for USB Devices](buses.microsoft_defined_usb_descriptors)
...
<p></p>
[USB device-side drivers in Windows](buses.usb_device-side_drivers_in_windows)
<p>A set of drivers for handling common function logic for USB devices.</p>
[USB host-side drivers in Windows](buses.usb_3_0_driver_stack_architecture)
...
[USB generic parent driver for composite devices–Usbccgp](buses.usb_common_class_generic_parent_driver)
...
<ul>
<li>[USB connector manager class extension (UcmCx)](buses.usb_connection_manager_class_extension__ucmcx_)</li>
<li>[USB host controller extension (UCX) reference](buses.usb_class_extension__ucx_)</li>
<li>[USB function class extension (UFX) reference](buses.usb_function_class_extension__ufx_)</li>
</ul>
<strong>Testing USB devices with Windows</strong>
<p></p>
[Testing USB hardware, drivers, and apps in Windows](buses.usb_driver_testing_guide)
...
[MUTT devices](buses.microsoft_usb_test_tool__mutt__devices)
...
<p>[Getting started with USB client driver development](buses.getting_started_with_usb_client_driver_development)</p>
<p>[USB client driver reference](buses.usb_reference)</p>
...
<p>[Developing Windows drivers for USB host controllers](buses.developing_windows_drivers_for_usb_host_controllers)</p>
<p>[USB host controller extension (UCX) reference](buses.usb_class_extension__ucx_)</p>
...
<p>[Developing Windows drivers for USB function controllers](buses.developing_windows_drivers_for_usb_function_controllers)</p>
<p>[USB function class extension (UFX) reference](buses.usb_function_class_extension__ufx_)</p>
...
<p>[Developing Windows drivers for USB Type-C connectors](buses.developing_windows_drivers_for_usb_type-c_connectors)</p>
<p>[USB connector manager class extension (UcmCx) reference](buses.usb_connection_manager_class_extension__ucmcx_)</p>
...
<p>[USB Dual Role Driver Stack Architecture](buses.usb_dual_role_driver_stack_architecture)</p>
<p>[USB dual-role controller driver programming reference](buses.usb_role_switch__urs__reference)</p>
...
<p>[Developing Windows drivers for emulated USB devices (UDE)](buses.developing_windows_drivers_for_emulated_usb_host_controllers_and_devices)</p>
<p>[Emulated USB host controller driver programming reference](buses.usb_emulated_device_driver_programming_reference)</p>
...
<p>[Talk to USB devices, start to finish](buses.talking_to_usb_devices_start_to_finish)</p>
...
<p>[Write a WinUSB application](buses.how_to_write_a_windows_desktop_app_that_communicates_with_a_usb_device)</p>
<p>[<strong>WinUSB Functions</strong>](buses.usb_interfaces#winusb)</p>
[Common programming scenarios](buses.wdk_resources_for_usb_driver_development)
