...
For more information, see [How to use or reference the Usbser.sys driver from universal serial bus (USB) modem .inf files](https://docs.microsoft.com/troubleshoot/windows-client/deployment/how-to-use-reference-usbser-driver-universal-serial-bus).
