...
For more about Windows power management and the PowerCfg tool, see [Powercfg Command-Line Options](https://technet.microsoft.com/library/cc748940(WS.10).aspx) and [Using PowerCfg to Evaluate System Energy Efficiency](https://msdn.microsoft.com/library/windows/hardware/gg463250.aspx).
