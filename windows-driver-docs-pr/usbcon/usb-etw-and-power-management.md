...
For more about Windows power management and the PowerCfg tool, see [Powercfg Command-Line Options](https://docs.microsoft.com/previous-versions/windows/it-pro/windows-vista/cc748940(v=ws.10)) and [Using PowerCfg to Evaluate System Energy Efficiency](https://msdn.microsoft.com/en-US/library/windows/hardware/dn550976).
