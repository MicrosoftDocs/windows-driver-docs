...
This topic teaches about changing a setting within a USB interface. You'll use the [**UsbInterfaceSetting**](/uwp/api/Windows.Devices.Usb.UsbInterfaceSetting) object to get the current setting and set a setting in the interface.
