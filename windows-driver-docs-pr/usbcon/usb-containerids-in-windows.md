...
To preserve legacy **ContainerID** functionality, the Microsoft OS string descriptor contains a flags field that can be used to indicate support for the **ContainerID** descriptor.
