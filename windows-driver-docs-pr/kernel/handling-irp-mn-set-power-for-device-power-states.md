...
Each driver (function, filter, and bus driver) in a driver stack must call [**PoSetPowerState**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ntifs/nf-ntifs-posetpowerstate) to inform the power manager of a change in the power state of its corresponding device object.
