...
As its name suggests, a [*StartIo*](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nc-wdm-driver_startio) routine is responsible for starting an I/O operation on the physical device.
...
You can use the [**IoSetStartIoAttributes**](https://docs.microsoft.com/windows-hardware/drivers/ddi/ntifs/nf-ntifs-iosetstartioattributes) routine to set attributes that modify *StartIo* handling for your driver.
