...
Starting in Windows 10, version 1809 and Windows Server 2019, you can provide a KbCallbackTriageDumpData callback routine to add virtual memory ranges to carved minidump file.  The dump data is described in a [**KBUGCHECK_TRIAGE_DUMP_DATA**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/ns-wdm-_kbugcheck_triage_dump_data) structure.
