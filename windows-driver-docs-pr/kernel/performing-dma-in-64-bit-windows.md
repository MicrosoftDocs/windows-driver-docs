...
5.  Set the **Dma64BitAddresses** member of the [**DEVICE\_DESCRIPTION**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/ns-wdm-_device_description) structure to **TRUE** to indicate that your driver supports 64-bit DMA addresses.
