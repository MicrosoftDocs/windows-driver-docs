...
-   **DevicePolicy** is a REG\_DWORD value that specifies an affinity policy. Each possible setting corresponds to a [**IRQ\_DEVICE\_POLICY**](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/ne-wdm-_irq_device_policy) value.
