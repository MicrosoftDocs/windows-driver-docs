...
this can lead to DOS attack because a thread holding one of these locks can be suspended. See [Introduction to Kernel Dispatcher Objects](/windows-hardware/drivers/kernel/introduction-to-kernel-dispatcher-objects).
