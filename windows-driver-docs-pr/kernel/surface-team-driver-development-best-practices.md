...
7. Trying to manage cancelation using Mark/UnmarkCancelable function instead of using IoQueues. See [Framework Queue Objects](/windows-hardware/drivers/wdf/creating-i-o-queues).
