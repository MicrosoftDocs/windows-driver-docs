...
For more information see [Using System DMA](using-system-dma.md) and [Using Bus-Master DMA](using-bus-master-dma.md) files about when and how drivers use adapter objects and *AdapterControl* routines.
