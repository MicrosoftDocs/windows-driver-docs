...
There are other relationships between devices on the machine besides the hierarchical relationships represented in the device tree. These include *removal relations* and *ejection relations*. See the reference page for [**IRP_MN_QUERY_DEVICE_RELATIONS**](./irp-mn-query-device-relations.md) for more information.
