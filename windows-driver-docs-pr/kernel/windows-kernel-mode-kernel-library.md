...
Routines that provide a direct interface to the kernel library are usually prefixed with "**Ke**", for example, **KeGetCurrentThread**. For a list of kernel library routines, see [Kernel Library Support Routines](https://docs.microsoft.com/windows-hardware/drivers/ddi/_kernel/#core-kernel-library-support-routines).
