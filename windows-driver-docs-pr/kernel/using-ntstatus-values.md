...
> [!IMPORTANT]
> If you're looking for a table of mappings of NTSTATUS values to the corresponding Win32 error codes, see [NTSTATUS to Win32 Error Code Mappings](https://www.osr.com/blog/2020/04/23/ntstatus-to-win32-error-code-mappings/).
...
NTSTATUS values are divided into four types:
