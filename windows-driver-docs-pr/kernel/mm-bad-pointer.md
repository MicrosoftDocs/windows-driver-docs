...
<p>Pointer to the [<strong>ANSI_STRING</strong>](https://msdn.microsoft.com/library/windows/hardware/ff540605) structure to be initialized.</p>
<p><em>Buffer [in]</em></p>
<p><strong>PCHAR</strong></p>
...
<p>To initialize a non-empty counted Unicode string, call [<strong>RtlInitAnsiString</strong>](https://msdn.microsoft.com/library/windows/hardware/ff561918).</p>
...
<p>Pointer to the [<strong>UNICODE_STRING</strong>](https://msdn.microsoft.com/library/windows/hardware/ff564879) structure to be initialized.</p>
<p><em>Buffer [in]</em></p>
...
<p>To initialize a non-empty counted Unicode string, call [<strong>RtlInitUnicodeString</strong>](https://msdn.microsoft.com/library/windows/hardware/ff561934).</p>
...
<p>Specifies the [<strong>LUID</strong>](https://msdn.microsoft.com/library/windows/hardware/ff554334) to check.</p>
<p><strong>Return value</strong></p>
