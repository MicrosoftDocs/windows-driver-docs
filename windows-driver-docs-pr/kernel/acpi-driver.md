...
For the latest *Advanced Configuration and Power Interface Specification*, see the [ACPI 5.0 specification](http://www.uefi.org/specifications) available from the Unified Extensible Firmware Interface Forum website. 
