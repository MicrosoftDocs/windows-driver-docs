...
The following code snippet shows how to use the [*GetBusData*](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nc-wdm-get_set_device_data) interface routine to get the configuration space data (step 2).
