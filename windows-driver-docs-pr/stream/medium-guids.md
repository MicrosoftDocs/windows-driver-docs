...
A minidriver describes mediums with the [**KSPIN\_MEDIUM**](/windows-hardware/drivers/stream/kspin-medium-structure) structure that consists of a GUID data type member (**Set**) followed by two ULONG members (**Id** and **Flags**):
