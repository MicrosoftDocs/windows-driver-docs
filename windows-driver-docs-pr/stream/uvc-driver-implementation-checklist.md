...
## Step 4: Implement Microsoft-specified UVC extensions
    ...
    - Method 2 still image capture:
        ...
        - Microsoft-specific documentation:
            ...
            - Review section 2.2.1 and 2.2.2 in the [Microsoft extensions to USB Video Class 1.5 specification](https://msdn.microsoft.com/en-us/windows/hardware/drivers/stream/uvc-extensions-1-15).
