...
All event sets must support the KSEVENT\_TYPE\_BASICSUPPORT flag. Refer to [**KSEVENT**](/previous-versions/ff561744(v=vs.85)) for a list of available event flags.
