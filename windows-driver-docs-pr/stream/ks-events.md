...
All event sets must support the KSEVENT\_TYPE\_BASICSUPPORT flag. Refer to [**KSEVENT**](/windows-hardware/drivers/stream/ksevent-structure) for a list of available event flags.
