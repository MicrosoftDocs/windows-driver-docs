...
The *ClockSupportFlags* member of the [**HW\_CLOCK\_OBJECT**](https://docs.microsoft.com/windows-hardware/drivers/ddi/strmini/ns-strmini-_hw_clock_object) structure is set to one of the following values:
