...
For more information, see [**KSDEGRADE**](https://docs.microsoft.com/previous-versions/ff561671(v=vs.85)) and [**KSDEGRADE\_STANDARD**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ks/ne-ks-ksdegrade_standard).
