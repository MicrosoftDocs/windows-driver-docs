...
Use the [**INIT\_AVCSTRM\_HEADER**](/windows-hardware/drivers/ddi/avcstrm/nf-avcstrm-init_avcstrm_header) macro to initialize these members. Pass **AVCSTRM\_SET\_STATE** in the Request argument of the macro.
