...
To register your plug-in, export functions called [DllRegisterServer](https://go.microsoft.com/fwlink/p/?linkid=106441) and [DllUnregisterServer](https://go.microsoft.com/fwlink/p/?linkid=106443) in the DLL that implements the COM object. These functions are declared in *Olectl.h* but are user-defined.
...
1.  Call [AMovieDllRegisterServer2](https://go.microsoft.com/fwlink/p/?linkid=106448) with a value of **TRUE** to register the filter.

2.  Call [RegCreateKeyEx](https://go.microsoft.com/fwlink/p/?linkid=106454) to create and receive a handle to the HKLM\\System\\CurrentControlSet\\Control\\MediaInterfaces key.

3.  Use [RegSetValueEx](https://go.microsoft.com/fwlink/p/?linkid=106447) to set a value under the HKLM\\System\\CurrentControlSet\\Control\\MediaInterfaces key that maps your property set to an interface handler. For more information about interface handlers, see [Interface Handler Plug-in](interface-handler-plug-in.md).

4.  Because the key is not one of the predefined registry keys, call [RegCloseKey](https://go.microsoft.com/fwlink/p/?linkid=106444) to close the handle to the key.
...
3.  Use [RegDeleteKey](https://go.microsoft.com/fwlink/p/?linkid=106446) to delete the subkey.
