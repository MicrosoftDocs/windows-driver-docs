...
[**KSPROPERTY\_TUNER\_SCAN\_CAPS**](https://docs.microsoft.com/windows-hardware/drivers/stream/ksproperty-tuner-scan-caps) (Required)

[**KSPROPERTY\_TUNER\_SCAN\_STATUS**](https://docs.microsoft.com/windows-hardware/drivers/stream/ksproperty-tuner-scan-status) (Optional)

[**KSPROPERTY\_TUNER\_NETWORKTYPE\_SCAN\_CAPS**](https://docs.microsoft.com/windows-hardware/drivers/stream/ksproperty-tuner-networktype-scan-caps) (Optional)

[**KSEVENT\_TUNER\_INITIATE\_SCAN**](https://docs.microsoft.com/windows-hardware/drivers/stream/ksevent-tuner-initiate-scan) (Optional)
