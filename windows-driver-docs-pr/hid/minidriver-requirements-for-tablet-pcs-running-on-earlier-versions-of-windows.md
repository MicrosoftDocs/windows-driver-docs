...
-   If the device is a USB device, a Tablet PC pen device must support the [USB selective suspend feature](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/index).
