...
MS-HAID:
- 'di\_f0257519-0945-4cdb-8580-950139f729da.xml'
- 'hid.original\_interface'
MSHAttr:
...
-   A Joystick Identification Callback used by VJoyD to inform a minidriver of the joysticks, which it should respond to.
