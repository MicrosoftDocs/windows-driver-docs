...
Refer to Section 13 of the [HID I2C Protocol Spec](https://docs.microsoft.com/en-us/previous-versions/windows/hardware/design/dn642101(v=vs.85)) for more detail.
