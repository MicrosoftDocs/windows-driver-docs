...
:::image type="content" source="images/kemocfg1.png" alt-text="Diagram illustrating two configurations that employ a single keyboard and a single mouse." border="false":::
...
:::image type="content" source="images/km-ovr2.png" alt-text="Diagram illustrating the configuration of device objects for a plug and play ps/2-style keyboard and mouse device." border="false":::
