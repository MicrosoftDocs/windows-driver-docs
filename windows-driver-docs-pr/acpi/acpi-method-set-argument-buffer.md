...
MS-HAID:
- 'acpi-meth-eval-ref\_d4713260-91cb-4477-9cf7-3cc078da64cc.xml'
- 'acpi.acpi\_method\_set\_argument\_buffer'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 1f335814-fa9f-45c6-b970-10884e971ec1
keywords: ["ACPI_METHOD_SET_ARGUMENT_BUFFER macro ACPI Devices"]
topic_type:
- apiref
api_name:
