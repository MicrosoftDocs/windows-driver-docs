...
## [Debugger Programming Reference](debugger/debugger-programming-reference.md)
## [Custom Analysis Debugger Extension Reference](debugger/custom-analysis-debugger-extension-reference.md)
## [Debug Engine Interfaces](debugger/client-com-interfaces.md)
## [Debugger Engine Reference](debugger/debugger-engine-reference.md)
### [Request](debugger/request.md)
#### [DEBUG_REQUEST_SOURCE_PATH_HAS_SOURCE_SERVER](debugger/debug-request-source-path-has-source-server.md)
#### [DEBUG_REQUEST_TARGET_EXCEPTION_CONTEXT](debugger/debug-request-target-exception-context.md)
#### [DEBUG_REQUEST_TARGET_EXCEPTION_THREAD](debugger/debug-request-target-exception-thread.md)
#### [DEBUG_REQUEST_TARGET_EXCEPTION_RECORD](debugger/debug-request-target-exception-record.md)
#### [DEBUG_REQUEST_GET_ADDITIONAL_CREATE_OPTIONS](debugger/debug-request-get-additional-create-options.md)
#### [DEBUG_REQUEST_SET_ADDITIONAL_CREATE_OPTIONS](debugger/debug-request-set-additional-create-options.md)
#### [DEBUG_REQUEST_GET_WIN32_MAJOR_MINOR_VERSIONS](debugger/debug-request-get-win32-major-minor-versions.md)
#### [DEBUG_REQUEST_TARGET_CAN_DETACH](debugger/debug-request-target-can-detach.md)
#### [DEBUG_REQUEST_SET_LOCAL_IMPLICIT_COMMAND_LINE](debugger/debug-request-set-local-implicit-command-line.md)
#### [DEBUG_REQUEST_GET_CAPTURED_EVENT_CODE_OFFSET](debugger/debug-request-get-captured-event-code-offset.md)
#### [DEBUG_REQUEST_READ_CAPTURED_EVENT_CODE_STREAM](debugger/debug-request-read-captured-event-code-stream.md)
#### [DEBUG_REQUEST_EXT_TYPED_DATA_ANSI](debugger/debug-request-ext-typed-data-ansi.md)
##### [EXT_TDOP_COPY](debugger/ext-tdop-copy.md)
##### [EXT_TDOP_RELEASE](debugger/ext-tdop-release.md)
##### [EXT_TDOP_SET_FROM_EXPR](debugger/ext-tdop-set-from-expr.md)
##### [EXT_TDOP_SET_FROM_U64_EXPR](debugger/ext-tdop-set-from-u64-expr.md)
##### [EXT_TDOP_GET_FIELD](debugger/ext-tdop-get-field.md)
##### [EXT_TDOP_EVALUATE](debugger/ext-tdop-evaluate.md)
##### [EXT_TDOP_GET_TYPE_NAME](debugger/ext-tdop-get-type-name.md)
##### [EXT_TDOP_OUTPUT_TYPE_NAME](debugger/ext-tdop-output-type-name.md)
##### [EXT_TDOP_OUTPUT_SIMPLE_VALUE](debugger/ext-tdop-output-simple-value.md)
##### [EXT_TDOP_OUTPUT_FULL_VALUE](debugger/ext-tdop-output-full-value.md)
##### [EXT_TDOP_HAS_FIELD](debugger/ext-tdop-has-field.md)
##### [EXT_TDOP_GET_FIELD_OFFSET](debugger/ext-tdop-get-field-offset.md)
##### [EXT_TDOP_GET_ARRAY_ELEMENT](debugger/ext-tdop-get-array-element.md)
##### [EXT_TDOP_GET_DEREFERENCE](debugger/ext-tdop-get-dereference.md)
##### [EXT_TDOP_GET_TYPE_SIZE](debugger/ext-tdop-get-type-size.md)
##### [EXT_TDOP_OUTPUT_TYPE_DEFINITION](debugger/ext-tdop-output-type-definition.md)
##### [EXT_TDOP_GET_POINTER_TO](debugger/ext-tdop-get-pointer-to.md)
##### [EXT_TDOP_SET_FROM_TYPE_ID_AND_U64](debugger/ext-tdop-set-from-type-id-and-u64.md)
##### [EXT_TDOP_SET_PTR_FROM_TYPE_ID_AND_U64](debugger/ext-tdop-set-ptr-from-type-id-and-u64.md)
## [ExtExtension](debugger/extextension.md)
## [Specific Exceptions](debugger/specific-exceptions.md)
## [WdbgExts Functions](debugger/wdbgexts-functions.md)
