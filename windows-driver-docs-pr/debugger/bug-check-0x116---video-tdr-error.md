---
title: Bug Check 0x116 VIDEO\_TDR\_ERROR
description: The VIDEO\_TDR\_ ERROR bug check has a value of 0x00000116. This indicates that an attempt to reset the display driver and recover from a timeout failed.
