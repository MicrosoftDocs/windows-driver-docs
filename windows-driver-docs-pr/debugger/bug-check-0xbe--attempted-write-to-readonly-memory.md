---
title: Bug Check 0xBE ATTEMPTED\_WRITE\_TO\_READONLY\_MEMORY
description: The ATTEMPTED\_WRITE\_TO\_READONLY\_MEMORY bug check has a value of 0x000000BE. This is issued if a driver attempts to write to a read-only memory segment.
