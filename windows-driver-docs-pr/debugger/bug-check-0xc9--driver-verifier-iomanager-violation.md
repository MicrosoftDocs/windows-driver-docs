...
<td align="left"><p>Non-fatal error</p></td>
<td align="left"><p>An IRP dispatch handler has returned a status that is illegal (0xFFFFFFFF). This is probably due to an uninitialized stack variable. To debug this error, use the [<strong>ln (List Nearest Symbols)</strong>](https://msdn.microsoft.com/library/windows/hardware/ff552029) command with the specified address.</p></td>
</tr>
<tr class="odd">
