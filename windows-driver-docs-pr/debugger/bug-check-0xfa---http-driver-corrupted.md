---
title: Bug Check 0xFA HTTP\_DRIVER\_CORRUPTED
description: The HTTP\_DRIVER\_CORRUPTED bug check has a value of 0x000000FA. This indicates that the HTTP kernel driver (Http.sys) has reached a corrupted state and cannot recover.
