...
For a complete list of the extension commands in Ks.dll, see [Kernel Streaming Extensions (Ks.dll)](https://msdn.microsoft.com/library/windows/hardware/ff551910).
