...
1.	**INSTALLATION AND USE RIGHTS.**
    1. **General.** You may install and run one instance of the software on your Windows 10 devices that are linked to the Microsoft account associated with your Microsoft Store account. You may not use the software in a live operating environment unless Microsoft permits you to do so under another agreement.
    ...
    3. **Third Party Software.** The software may include third party applications that Microsoft, not the third party, licenses to you under this agreement. Any included notices for third party applications are for your information only.
...
5.	**SCOPE OF LICENSE.** The software is licensed, not sold. Microsoft reserves all other rights. Unless applicable law gives you more rights despite this limitation, you will not (and have no right to):
    ...
    4. disclose the results of any benchmark tests of the software to any third party without Microsoft’s prior written approval;
    5. use the software for commercial, non-profit, or revenue-generating activities;
