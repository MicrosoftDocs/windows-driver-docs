...
Secondary data of tag {E1D08891-D5A3-45F9-B811-AD711DFB2607} contains additional “Blackbox” data. Use [**.enumtag (Enumerate Secondary Callback Data)**](https://msdn.microsoft.com/library/windows/hardware/ff562987) to view the data.
