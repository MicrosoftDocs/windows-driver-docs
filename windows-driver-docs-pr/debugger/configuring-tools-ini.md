...
<td align="left"><p>Sets the source line options that control source display and program stepping options. For more information see [<strong>l+, l- (Set Source Options)</strong>](https://msdn.microsoft.com/library/windows/hardware/ff552114).</p></td>
</tr>
<tr class="odd">
<td align="left"><p><strong>srcpath:</strong> <em>directory</em></p></td>
<td align="left"><p>Sets the source file search path. For more information see [<strong>.srcpath, .lsrcpath (Set Source Path)</strong>](https://msdn.microsoft.com/library/windows/hardware/ff565378).</p></td>
</tr>
<tr class="even">
