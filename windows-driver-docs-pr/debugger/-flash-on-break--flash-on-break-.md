---
title: .flash\_on\_break (Flash on Break)
description: The .flash\_on\_break command specifies whether the WinDbg taskbar entry flashes when WinDbg is minimized and the target breaks.
