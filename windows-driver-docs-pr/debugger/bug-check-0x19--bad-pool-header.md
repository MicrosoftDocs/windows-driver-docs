---
title: (Developer Content) Bug Check 0x19 BAD\_POOL\_HEADER
...
Then you can use special pool for the suspect pool tags, or use Driver Verifier "Special Pool" option on the suspect driver. The [**!analyze**](https://msdn.microsoft.com/library/windows/hardware/ff562112) extension may be of help in pinpointing the suspect driver, but this is frequently not the case with pool corrupters.
