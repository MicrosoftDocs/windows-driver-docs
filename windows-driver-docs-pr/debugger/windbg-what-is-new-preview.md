...
**Support for Open Enclave** - WinDbg Preview can now debug Open Enclave (OE) applications, you can find directions for how to do this in the [Open Enclave documentation](https://github.com/openenclave/openenclave/blob/0deb7c67911e22b3151997f4f631ed5cf4ad7e30/docs/GettingStartedDocs/Windows_windbg.md).
