---
title: Bug Check 0xA3 ACPI\_DRIVER\_INTERNAL
description: The ACPI\_DRIVER\_INTERNAL bug check has a value of 0x000000A3. This bug check indicates that the ACPI driver detected an internal inconsistency.
