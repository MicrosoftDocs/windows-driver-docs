...
3.  On the target computer, open a Command Prompt window and enter the command **verifier**. Use [Driver Verifier Manager](http://go.microsoft.com/fwlink/p?LinkID=268659) to enable Driver Verifier for your driver.
...
[Static Driver Verifier](http://go.microsoft.com/fwlink/p?LinkID=268668)
