---
title: Bug Check 0x9E USER\_MODE\_HEALTH\_MONITOR
description: The USER\_MODE\_HEALTH\_MONITOR bug check has a value of 0x0000009E. This bug check indicates that one or more critical user-mode components failed to satisfy a health check.
