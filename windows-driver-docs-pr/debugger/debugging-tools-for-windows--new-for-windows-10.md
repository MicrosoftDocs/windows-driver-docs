...
-   Updates to the [**dx (Display Debugger Object Model Expression)**](https://msdn.microsoft.com/library/windows/hardware/dn936815) command, to include new command capabilities.
-   New [**dtx (Display Type - Extended Debugger Object Model Information)**](https://msdn.microsoft.com/library/windows/hardware/mt790251) command.
-   New [**!ioctldecode**](https://msdn.microsoft.com/library/windows/hardware/mt790255) command.
...
-   [**.settings (Set Debug Settings)**](https://msdn.microsoft.com/library/windows/hardware/dn925473) - New command that allows you to set, modify, display, load and save settings in the Debugger.Settings namespace.
-   [**dx (Display NatVis Expression)**](https://msdn.microsoft.com/library/windows/hardware/dn936815) - Describes the new dx debugger command, which displays object information using the NatVis extension model and LINQ support.
-   New commands that work with the NatVis visualization files in the debugger environment.
    -   [**.nvlist (NatVis List)**](https://msdn.microsoft.com/library/windows/hardware/mt146557)
    -   [**.nvload (NatVis Load)**](https://msdn.microsoft.com/library/windows/hardware/mt146547)
    -   [**.nvunload (NatVis Unload)**](https://msdn.microsoft.com/library/windows/hardware/mt146548)
    -   [**.nvunloadall (NatVis Unload All)**](https://msdn.microsoft.com/library/windows/hardware/mt146558)
-   [Bluetooth Extensions (Bthkd.dll)](https://msdn.microsoft.com/library/windows/hardware/dn957514)
-   [Storage Kernel Debugger Extensions](https://msdn.microsoft.com/library/windows/hardware/dn997250)
...
-   [**CDB Command-Line Options**](https://msdn.microsoft.com/library/windows/hardware/ff539058) - Updated to include new command line options.
-   [**!analyze**](https://msdn.microsoft.com/library/windows/hardware/ff562112) - Updated to include information about using this extension with UMDF 2.15.
-   [**!wdfkd.wdfcrashdump**](https://msdn.microsoft.com/library/windows/hardware/ff565682)- Updated to include information about using this extension with UMDF 2.15
-   [**!irp**](https://msdn.microsoft.com/library/windows/hardware/ff563812) - Updated. Starting with Windows 10 the IRP major and minor code text is displayed in command output.
