---
title: Bug Check 0x10D WDF\_VIOLATION
...
The [**!analyze**](https://msdn.microsoft.com/library/windows/hardware/ff562112) debug extension displays information about the bug check and can be very helpful in gathering information, such as the faulting code module.
...
If Parameter 1 is equal to **0x4**, use the [**ln debugger**](https://msdn.microsoft.com/library/windows/hardware/ff552029) command with the value of *Parameter 3* as its argument to determine which function requires a non-**NULL** parameter.
