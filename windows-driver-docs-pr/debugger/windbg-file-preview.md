...
Use *Start debugging* to configure new and open existing debugger sessions. Session connection information is stored in workspace configuration files.
...
## About
Use *About* to display build version information for the debugger. You can use this screen to view the Microsoft privacy statement as well.
