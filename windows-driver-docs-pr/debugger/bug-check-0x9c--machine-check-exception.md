---
title: Bug Check 0x9C MACHINE\_CHECK\_EXCEPTION
description: The MACHINE\_CHECK\_EXCEPTION bug check has a value of 0x0000009C. This bug check indicates that a fatal machine check exception has occurred.
