...
description: The ndiskd.dbglevel extension displays and optionally changes the current NDIS debug level.Warning � ndiskd.dbglevel has been superceded by WPP (Windows software trace preprocessor) and Driver Verifier.
