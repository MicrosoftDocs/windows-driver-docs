---
title: Bug Check 0xBB NETWORK\_BOOT\_INITIALIZATION\_FAILED
description: The NETWORK\_BOOT\_INITIALIZATION\_FAILED bug check has a value of 0x000000BB. This indicates that Windows failed to successfully boot off a network.
