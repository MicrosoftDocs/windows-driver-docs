---
title: Bug Check 0x12D VOLSNAP\_OVERLAPPED\_TABLE\_ACCESS
description: The VOLSNAP\_OVERLAPPED\_TABLE\_ACCESS bug check has a value of 0x0000012D that indicates that volsnap tried to access a common table from two different threads.
