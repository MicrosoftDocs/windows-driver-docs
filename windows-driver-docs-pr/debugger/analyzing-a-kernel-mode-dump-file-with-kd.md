...
The **-v** option (verbose mode) is also useful. For a full list of options, see [**KD Command-Line Options**](https://msdn.microsoft.com/library/windows/hardware/ff551851).
