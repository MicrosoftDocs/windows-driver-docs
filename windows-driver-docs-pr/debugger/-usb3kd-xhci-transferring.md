---
title: usb3kd.xhci\_transferring
description: The usb3kd.xhci\_transferring extension displays a transfer ring (used by a USB 3.0 host controller) until it detects a cycle bit change.
