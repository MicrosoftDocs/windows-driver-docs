...
<td align="left"><p>The address of the specific miniport adapter block. Run [<strong>!ndiskd.netadapter</strong>](https://msdn.microsoft.com/library/windows/hardware/mt799821) with this address for more information.</p></td>
...
<td align="left"><p>The address of the specific miniport adapter block. Run [<strong>!ndiskd.netadapter</strong>](https://msdn.microsoft.com/library/windows/hardware/mt799821) with this address for more information.</p></td>
<td align="left"><p>The address of the packet descriptor used by the driver. Run [<strong>!ndiskd.pkt</strong>](https://msdn.microsoft.com/library/windows/hardware/ff564165) with this address for more information.</p></td>
...
<td align="left"><p>The address of the specific protocol. Run [<strong>!ndiskd.protocol</strong>](https://msdn.microsoft.com/library/windows/hardware/ff564546) with this address for more information.</p></td>
...
<td align="left"><p>The address of the open handle. Run [<strong>!ndiskd.mopen</strong>](https://msdn.microsoft.com/library/windows/hardware/ff564152) with this address for more information.</p></td>
</tr>
<tr class="odd">
...
<td align="left"><p>The address of the interface provider handle. Run [<strong>!ndiskd.ifprovider</strong>](https://msdn.microsoft.com/library/windows/hardware/mt782493) with this address for more information.</p></td>
<td align="left"><p>0</p></td>
<td align="left"><p>0</p></td>
</tr>
<tr class="even">
...
<p>A driver attempted to add an Interface to the ifStackTable, but doing so would cause a cycle. The ifStackTable must not have cycles. Run [<strong>!ndiskd.ifstacktable</strong>](https://msdn.microsoft.com/library/windows/hardware/mt782494) to see the current table (prior to this call to [<strong>NdisIfAddIfStackEntry</strong>](https://msdn.microsoft.com/library/windows/hardware/ff562693)).</p></td>
...
<td align="left"><p>The address of the specific miniport adapter block. Run [<strong>!ndiskd.netadapter</strong>](https://msdn.microsoft.com/library/windows/hardware/mt799821) with this address for more information.</p></td>
<td align="left"><p>The OID that was failed. Use [<strong>!ndiskd.help</strong>](https://msdn.microsoft.com/library/windows/hardware/ff564124) to find the name of this OID.</p></td>
...
<td align="left"><p>The address of the specific miniport adapter or filter module block. Run [<strong>!ndiskd.netadapter</strong>](https://msdn.microsoft.com/library/windows/hardware/mt799821) or [<strong>!ndiskd.filter</strong>](https://msdn.microsoft.com/library/windows/hardware/ff564109) with this address for more information.</p></td>
<td align="left"><p>The address to the [<strong>NDIS_OID_REQUEST</strong>](https://msdn.microsoft.com/library/windows/hardware/ff566710) that was completed illegally. Inspect it with [<strong>!ndiskd.oid</strong>](https://msdn.microsoft.com/library/windows/hardware/mt799824).</p></td>
<td align="left"><p>0</p></td>
</tr>
<tr class="odd">
...
<td align="left"><p>0</p></td>
<td align="left"><p>Internal handle. Use [<strong>!ndiskd.ndisref</strong>](https://msdn.microsoft.com/library/windows/hardware/mt799817) or cast to ndis!NDIS_REFCOUNT_BLOCK.</p></td>
...
<td align="left"><p>The type of the status indication. Run [<strong>!ndiskd.help</strong>](https://msdn.microsoft.com/library/windows/hardware/ff564124) with this code for more information.</p></td>
<td align="left"><p>The handle of the driver instance that indicated this illegal status indication. Run [<strong>!ndiskd.netadapter</strong>](https://msdn.microsoft.com/library/windows/hardware/mt799821) or [<strong>!ndiskd.filter</strong>](https://msdn.microsoft.com/library/windows/hardware/ff564109) with this handle for more information.</p></td>
...
<td align="left"><p>The handle of the driver that indicated the illegal status indication. Run [<strong>!ndiskd.minidriver</strong>](https://msdn.microsoft.com/library/windows/hardware/mt782496) or [<strong>!ndiskd.filterdriver</strong>](https://msdn.microsoft.com/library/windows/hardware/mt782492) with this handle for more information.</p></td>
...
<li>Cast to NDIS_PD_QUEUE_TRACKER</li>
<li>Cast to NDIS_PD_QUEUE_TRACKER</li>
<li>The handle of the specific filter module. Run [<strong>!ndiskd.filter</strong>](https://msdn.microsoft.com/library/windows/hardware/ff564109) with this handle for more information.</li>
...
<li>The handle to the PD provider. Run [<strong>!ndiskd.netadapter</strong>](https://msdn.microsoft.com/library/windows/hardware/mt799821) with this handle for more information.</li>
<li>The handle to the PD provider. Run [<strong>!ndiskd.netadapter</strong>](https://msdn.microsoft.com/library/windows/hardware/mt799821) with this handle for more information.</li>
<li>The handle to the PD provider. Run [<strong>!ndiskd.netadapter</strong>](https://msdn.microsoft.com/library/windows/hardware/mt799821) with this handle for more information.</li>
...
<td align="left"><p>The miniport driver handle that caused the bugcheck. Run [<strong>!ndiskd.minidriver</strong>](https://msdn.microsoft.com/library/windows/hardware/mt782496) with this handle for more information.</p></td>
<td align="left"><p>The NDIS OID request the miniport driver was trying to complete. You can try to run [<strong>!ndiskd.oid</strong>](https://msdn.microsoft.com/library/windows/hardware/mt799824) with this request but the memory might not be valid at this point.</p></td>
<td align="left"><p>0</p></td>
</tr>
<tr class="even">
<td align="left"><p>0x27</p></td>
<td align="left"><p>NDIS_BUGCHECK_LEAKED_NBL</p>
<p>A driver has leaked a [<strong>NET_BUFFER_LIST</strong>](https://msdn.microsoft.com/library/windows/hardware/ff568388) structure. Check with [<strong>!ndiskd.pendingnbls</strong>](https://msdn.microsoft.com/library/windows/hardware/mt799825) to see any NBLs that are still pending on this driver.</p></td>
...
The BUGCODE\_NDIS\_DRIVER bugcheck indendifies problems in network drivers. Often, the problem is caused by a NDIS miniport driver. You can get a complete list of NDIS miniport drivers by using [**!ndiskd.netadapter**](https://msdn.microsoft.com/library/windows/hardware/mt799821). You can get a bigger picture overview of the network stack with [**!ndiskd.netreport**](https://msdn.microsoft.com/library/windows/hardware/mt799822).
