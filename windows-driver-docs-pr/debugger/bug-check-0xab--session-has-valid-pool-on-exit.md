---
title: Bug Check 0xAB SESSION\_HAS\_VALID\_POOL\_ON\_EXIT
description: The SESSION\_HAS\_VALID\_POOL\_ON\_EXIT bug check has a value of 0x000000AB. This bug check indicates that a session unload occurred while a session driver still held memory.
