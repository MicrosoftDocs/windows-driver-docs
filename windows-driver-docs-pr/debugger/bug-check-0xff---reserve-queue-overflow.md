---
title: Bug Check 0xFF RESERVE\_QUEUE\_OVERFLOW
description: The RESERVE\_QUEUE\_OVERFLOW bug check has a value of 0x000000FF. This indicates that an attempt was made to insert a new item into a reserve queue, causing the queue to overflow.
