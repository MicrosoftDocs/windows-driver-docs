---
title: Bug Check 0x100 LOADER\_BLOCK\_MISMATCH
description: The LOADER\_BLOCK\_MISMATCH bug check has a value of 0x00000100. This indicates that either the loader block is invalid, or it does not match the system that is being loaded.
