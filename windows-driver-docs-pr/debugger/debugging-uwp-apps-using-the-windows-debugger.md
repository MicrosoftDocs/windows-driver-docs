...
To debug a managed-code Windows app, load the [SOS debugging extension (sos.dll)](https://docs.microsoft.com/dotnet/framework/tools/sos-dll-sos-debugging-extension) and a data access component (mscordacwks.dll). For more information, see [Debugging Managed Code Using the Windows Debugger](debugging-managed-code.md).
