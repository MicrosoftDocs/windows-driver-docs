---
title: Bug Check 0xE2 MANUALLY\_INITIATED\_CRASH
description: The MANUALLY\_INITIATED\_CRASH bug check has a value of 0x000000E2. This indicates that the user deliberately initiated a crash dump from either the kernel debugger or the keyboard.
