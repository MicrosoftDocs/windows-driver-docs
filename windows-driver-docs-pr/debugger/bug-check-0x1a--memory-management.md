...
|---|---|
| 0x1 | The fork clone block reference count is corrupted. This problem occurs only on checked builds of Windows. Checked builds were available in earlier versions of Windows, before Windows 10 version 1803. |
