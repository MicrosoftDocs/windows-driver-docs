---
title: Bug Check 0xC6 DRIVER\_CAUGHT\_MODIFYING\_FREED\_POOL
description: The DRIVER\_CAUGHT\_MODIFYING\_FREED\_POOL bug check has a value of 0x000000C6. This indicates that the driver attempted to access a freed memory pool.
