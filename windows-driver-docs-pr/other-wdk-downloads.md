...
| Windows 8.1 Update       | WDK 8.1 Update (English only) - permanently unavailable<br/>WDK 8.1 Update Test Pack (English only) - permanently unavailable <br/>[WDK 8.1 Samples](https://go.microsoft.com/fwlink/p/?LinkId=618052)  <br/>The WDK from Windows 10, version 1607 to Windows 11, version 21H2 can be used to build drivers for Windows 8.1.|
