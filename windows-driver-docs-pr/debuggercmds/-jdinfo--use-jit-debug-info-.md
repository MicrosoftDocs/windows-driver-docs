...
For more information about the registry keys used, see [Enabling Postmortem Debugging](../debugger/enabling-postmortem-debugging.md). For more information about register contexts, see [Changing Contexts](../debugger/changing-contexts.md).
