...
Specifies that the format string contains [Debugger Markup Language](../debugger/debugger-markup-language-commands.md) (DML).
...
:::image type="content" source="images/printf01.png" alt-text="Screenshot of DML link in command browser window.":::
