...
Use the new model query dialog to create a new model query. You can put anything here that you put into a normal `dx` command.

For example, specify `Debugger.Sessions` to examine the debugger sessions objects.

:::image type="content" source="images/windbgx-data-model-new-model-dialog.png" alt-text="Screenshot of the new data model query dialog in WinDbg.":::
...
:::image type="content" source="images/windbgx-data-model-process-threads.png" alt-text="Screenshot of the data model explorer window displaying processes and threads in WinDbg.":::
...
:::image type="content" source="images/windbgx-data-model-pnp-device.png" alt-text="Screenshot of the data model explore window presenting a plug-and-play device tree in the grid view in WinDbg.":::
