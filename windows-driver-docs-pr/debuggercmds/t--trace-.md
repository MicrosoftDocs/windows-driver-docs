...
Specifies the number of instructions or source lines to trace through before stopping. Each step is displayed as a separate action in the [Debugger Command window](../debugger/debugger-command-window.md). The default value is one.
