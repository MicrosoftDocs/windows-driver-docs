...
:::image type="content" source="images/usbkd01.png" alt-text="Diagram that shows a USB 2.0 tree with host controller devices, execution units, hubs, and connected devices.":::
