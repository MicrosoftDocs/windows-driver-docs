...
In any event, type information is included only in a full symbol file, not a symbol file that has been stripped of all private symbol information. For more information, see [Public and Private Symbols](../debugger/public-and-private-symbols.md).
