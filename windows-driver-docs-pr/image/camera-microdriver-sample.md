...
The microdrv directory in [WIA Driver Samples](https://docs.microsoft.com/samples/microsoft/windows-driver-samples/windows-image-acquisition-wia-driver-samples) contains a sample WIA microdriver for a digital still camera.
