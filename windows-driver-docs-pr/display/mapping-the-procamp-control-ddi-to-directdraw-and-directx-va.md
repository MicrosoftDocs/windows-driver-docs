...
description: Access the ProcAmp control functionality through DirectDraw's [motion compensation callback functions](motion-compensation-callbacks.md), and map it to the [ProcAmp control DDI](https://msdn.microsoft.com/library/windows/hardware/ff569186).
