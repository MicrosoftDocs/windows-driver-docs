...
The driver can use the GDI [**CLIPOBJ**](/windows/win32/api/winddi/ns-winddi-_clipobj) enumeration services to reduce the clipping to a series of clip rectangles. GDI passes down a translation vector, the [**XLATEOBJ**](/windows/win32/api/winddi/ns-winddi-_xlateobj) structure, to assist in color index translation between source and destination surfaces.
