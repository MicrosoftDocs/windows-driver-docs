...
The **bNewQmatrix** member of [**DXVA\_QmatrixData**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/dxva/ns-dxva-_dxva_qmatrixdata) equals zero, for i = 2 and 3 when inverse-quantization matrices are used.
