...
-   *ddkmapi.h* is used by video capture drivers to access the [**DxApi**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/dxapi/nf-dxapi-dxapi) function. DirectDraw, in turn, calls upon the DxApi interface.
...
Reference pages for DirectDraw driver functions, callbacks, and structures can be found in [DirectDraw Driver Functions](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/index) and [DirectDraw Driver Structures](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/index).
