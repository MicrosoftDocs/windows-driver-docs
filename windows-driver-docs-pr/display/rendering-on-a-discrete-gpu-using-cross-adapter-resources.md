...
Starting in Windows 8.1, a [discrete GPU](using-cross-adapter-resources-in-a-hybrid-system.md#definition-of-a-hybrid-system) uses a [cross-adapter resource](using-cross-adapter-resources-in-a-hybrid-system.md#definition-of-a-cross-adapter-resource) as:
...
An [integrated GPU](using-cross-adapter-resources-in-a-hybrid-system.md#definition-of-a-hybrid-system) uses a [cross-adapter resource](using-cross-adapter-resources-in-a-hybrid-system.md#definition-of-a-cross-adapter-resource) as:
