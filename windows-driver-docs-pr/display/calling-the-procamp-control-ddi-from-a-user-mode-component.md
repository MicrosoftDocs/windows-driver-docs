...
keywords: ["calling ProcAmp control DDI WDK DirectX VA", "user-mode component calls WDK DirectX VA", "ProcAmp WDK DirectX VA , calling from a user-mode component"]
---
