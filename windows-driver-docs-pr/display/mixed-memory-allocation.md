...
The following pseudocode shows how a [**VIDEOMEMORY**](/windows/desktop/api/ddrawint/ns-ddrawint-_videomemory) structure is set up for a mix of linear and rectangular memory:
