...
The DWM or the display miniport driver's [**DxgkDdiPresent**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/d3dkmddi/nc-d3dkmddi-dxgkddi_present) function rotates windowed-mode data.
