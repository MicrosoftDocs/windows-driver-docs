...
The user-mode display driver can use the [Direct3D Runtime Version 10 State-Refresh Callback Functions](https://docs.microsoft.com/windows-hardware/drivers/ddi/index) to achieve a stateless driver or to build up command buffer preamble data.
