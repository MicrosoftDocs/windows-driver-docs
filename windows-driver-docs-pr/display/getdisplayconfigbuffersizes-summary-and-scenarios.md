...
The following sections summarize how a caller uses [**GetDisplayConfigBufferSizes**](/windows/desktop/api/winuser/nf-winuser-getdisplayconfigbuffersizes) CCD function and provide scenarios for using **GetDisplayConfigBufferSizes**.
...
The caller can use [**GetDisplayConfigBufferSizes**](/windows/desktop/api/winuser/nf-winuser-getdisplayconfigbuffersizes) to obtain information that the caller requires for the [**QueryDisplayConfig**](/windows/desktop/api/winuser/nf-winuser-querydisplayconfig) CCD function.
...
[**GetDisplayConfigBufferSizes**](/windows/desktop/api/winuser/nf-winuser-getdisplayconfigbuffersizes) is always called before calling [**QueryDisplayConfig**](/windows/desktop/api/winuser/nf-winuser-querydisplayconfig).
