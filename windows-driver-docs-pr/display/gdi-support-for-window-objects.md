...
keywords: ["GDI WDK Windows 2000 display , window objects", "graphics drivers WDK Windows 2000 display , window objects", "drawing WDK GDI , window objects", "window objects WDK GDI"]
---
