...
keywords: ["DirectX 8.0 release notes WDK Windows 2000 display , multiple vertex streams", "multiple vertex streams WDK DirectX 8.0", "vertex multiple streams WDK DirectX 8.0", "stream zero WDK DirectX 8.0", "vertex stream zero WDK DirectX 8.0"]
---
