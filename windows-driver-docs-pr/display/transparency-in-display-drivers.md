...
If the display hardware supports transparency, the display driver should implement [**DrvTransparentBlt**](/windows/desktop/api/winddi/nf-winddi-drvtransparentblt).
