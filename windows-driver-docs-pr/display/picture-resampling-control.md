...
A single buffer type defined in the [**DXVA\_PicResample**](https://docs.microsoft.com/windows-hardware/drivers/ddi/dxva/ns-dxva-_dxva_picresample) structure controls the resampling process.
