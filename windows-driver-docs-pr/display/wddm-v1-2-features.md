...
[**Kernel Mode Display-Only Driver (KMDOD) Interface**](/windows-hardware/drivers/ddi/index)
...
[**Support for system on a chip (SoC) architecture through the SPB interface**](/windows-hardware/drivers/ddi/index)
...
[**System Firmware Table Interface**](/windows-hardware/drivers/ddi/dispmprt/ns-dispmprt-_dxgk_firmware_table_interface)

Lets the display miniport driver enumerate and read the system firmware table.

[**Brightness Control Interface V. 2 (Adaptive and Smooth Brightness Control)**](/windows-hardware/drivers/ddi/index)
...
Also see [Windows 8 brightness control for integrated displays](/previous-versions/windows/hardware/design/dn614018(v=vs.85)).
