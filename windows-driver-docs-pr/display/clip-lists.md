...
Clipped blts are never passed to the driver on Microsoft Windows 2000 and later. The **IsClipped** member of [**DD\_BLTDATA**](/windows/win32/api/ddrawint/ns-ddrawint-_dd_bltdata) is always **FALSE**, and the clipped list is always **NULL**.
