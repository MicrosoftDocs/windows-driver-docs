...
keywords: ["GDI WDK Windows 2000 display , memory services", "graphics drivers WDK Windows 2000 display , memory services", "drawing WDK GDI , memory services", "memory WDK GDI"]
---
