...
The exception for [source parameter tokens](https://docs.microsoft.com/windows-hardware/drivers/display/source-parameter-token) is with the following instruction:
