...
:::image type="content" source="images/cpu-host-aperture.1.png" alt-text="Diagram that shows CPU host aperture segment mapping in a GPU memory segment.":::
...
:::image type="content" source="images/cpu-host-aperture.2.png" alt-text="Diagram that shows CPU host aperture segment mapping for linked display adapter configurations.":::
