...
- The [minifilter model](https://docs.microsoft.com/windows-hardware/drivers/ifs/filter-manager-concepts), in which a minifilter (also called a filter) uses system-supplied Filter Manager support, thus simplifying filter development
