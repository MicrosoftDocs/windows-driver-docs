...
- The minifilter model, in which a minifilter uses system-supplied Filter Manager support, thus simplifying filter development

- The legacy file system filter model
