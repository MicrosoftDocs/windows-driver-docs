...
MUP performs prefix resolution by issuing an [**IOCTL\_REDIR\_QUERY\_PATH**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ntifs/ni-ntifs-ioctl_redir_query_path) request to network redirectors registered with MUP. The input and output buffers for IOCTL\_REDIR\_QUERY\_PATH are as follows:
