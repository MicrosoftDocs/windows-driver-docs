...
Minifilters should use [**FltTagFile**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/fltkernel/nf-fltkernel-flttagfile) instead of FSCTL\_SET\_REPARSE\_POINT to set a reparse point.
