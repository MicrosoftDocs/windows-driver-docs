...
For any other IRP request, the RDBSS dispatch routine [**RxFsdDispatch**](https://docs.microsoft.com/windows-hardware/drivers/ddi/mrx/nf-mrx-rxfsddispatch) will return a status of STATUS\_REDIRECTOR\_NOT\_STARTED.
...
The following macro is defined in the mrx.h header file that calls one of these routines. This macro is normally used instead of calling the [**\_\_RxFillAndInstallFastIoDispatch**](https://docs.microsoft.com/windows-hardware/drivers/ddi/mrx/nf-mrx-__rxfillandinstallfastiodispatch) routine directly.
