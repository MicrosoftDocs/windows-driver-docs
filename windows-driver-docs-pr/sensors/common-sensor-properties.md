...
|---|---|---|---|---|
| PKEY_Sensor_Type | **VT_CLSID** | R/O | Required | The type of sensor. The GUID consists of the same format as a Windows sensor (for example, SENSOR_TYPE_ACCELEROMETER_3D). For more information about sensor types, see [Sensor type GUIDs](/previous-versions/windows/hardware/sensors/about-sensor-constants). |
...
- [Sensor type GUIDs](/previous-versions/windows/hardware/sensors/about-sensor-constants)
