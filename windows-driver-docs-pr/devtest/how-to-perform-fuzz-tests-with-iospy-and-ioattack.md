...
> [!NOTE]
> IoAttack is no longer available in the WDK after Windows 10 Version 1703.
>
> As an alternative to this tool, consider using the fuzzing tests available in the HLK. Here are a few to consider.
> 
...
1. Run IOCTL and WMI tests on the specified devices:
...
1. Run [IoAttack](ioattack.md):
    ...
    > [!NOTE]
    > In order to verify the access privileges of your driver's IOCTL and WMI interfaces, you should run [IoAttack](ioattack.md) accounts with different privileges, such as a guest account and an administrator account.
