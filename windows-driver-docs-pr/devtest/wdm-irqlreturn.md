...
The **IrqlReturn** rule specifies that the driver's dispatch routines return at the same IRQL at which they were called. For more information about the IRQLs at which dispatch routines are properly called, see [**Dispatch Routines and IRQLs.**](../kernel/dispatch-routines-and-irqls.md)
...
<tbody>
<tr class="odd">
<td align="left"><p>Run <a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](./static-driver-verifier.md)">Static Driver Verifier</a> and specify the <strong>IrqlReturn</strong> rule.</p>
