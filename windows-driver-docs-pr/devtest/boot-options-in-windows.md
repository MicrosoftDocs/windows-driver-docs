...
BCD includes its own set of boot options. For more information about these boot options, see [BCD Boot Options Reference](/windows-hardware/drivers/devtest/bcd-boot-options-reference).
