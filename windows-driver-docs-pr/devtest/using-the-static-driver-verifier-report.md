...
The [Static Driver Verifier Rules](/windows-hardware/drivers/devtest/static-driver-verifier-rules) section includes a topic that explains each rule, for example, [CancelSpinLock](./wdm-cancelspinlock.md).
