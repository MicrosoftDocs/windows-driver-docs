...
Microsoft recommends that DPCs should not run longer than 100 microseconds and ISRs should not run longer than 25 microseconds. For the most recent requirements, see the [Hardware Lab Kit](https://docs.microsoft.com/windows-hardware/test/hlk/).
