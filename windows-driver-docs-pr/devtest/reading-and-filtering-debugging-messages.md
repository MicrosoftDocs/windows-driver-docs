...
If you disabled this display, you can view the contents of the DbgPrint buffer only by using the **!dbgprint** extension command. For information about debugger extensions, see [Windows Debugging](https://docs.microsoft.com/windows-hardware/drivers/debugger/index).
