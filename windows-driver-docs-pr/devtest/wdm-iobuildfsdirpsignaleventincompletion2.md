...
The **IoBuildFsdIrpSignalEventInCompletion2** rule specifies that [**KeSetEvent**](/windows-hardware/drivers/ddi/wdm/nf-wdm-kesetevent) needs to be called in the completion routine when the **Irp-&gt;PendingReturned** flag is set and the completion routine is processing a locally created asynchronous IRP.
...
<tbody>
<tr class="odd">
<td align="left"><p>Run <a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](./static-driver-verifier.md)">Static Driver Verifier</a> and specify the <strong>IoBuildFsdIrpSignalEventInCompletion2</strong> rule.</p>
