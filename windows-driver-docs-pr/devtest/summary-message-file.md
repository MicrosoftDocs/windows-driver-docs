...
The following example shows a summary message file for the testtrace.etl trace log that is generated by Tracedrv, a sample driver instrumented for tracing. [TraceDrv](https://github.com/Microsoft/Windows-driver-samples/tree/master/general/tracing/tracedriver), a sample driver that was designed for software tracing, is available from the [Windows driver samples](https://github.com/Microsoft/Windows-driver-samples) repository on GitHub.
