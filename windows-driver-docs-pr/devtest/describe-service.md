...
2. Fill out the following fields.
    ...
    - **Service Number**. Specify a GUID that uniquely identifies your service. This GUID is used to identify the operator when using operator XML provisioning. If you update the device metadata package, this GUID should remain the same.
        **Note**  This is a different value than the Experience ID and the file name of the device metadata package. For more information on selecting a GUID for Service Number, see [Overview of Using Metadata to Configure Mobile Broadband Experiences](https://docs.microsoft.com/windows-hardware/drivers/mobilebroadband/using-metadata-to-configure-mobile-broadband-experiences).
