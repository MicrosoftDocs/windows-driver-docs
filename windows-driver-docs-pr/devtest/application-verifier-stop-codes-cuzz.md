---
title: Application Verifier - Stop Codes - Cuzz 
description: Application Verifier - Stop Codes - Cuzz 
keywords:
...
# Application Verifier - Stop Codes - Cuzz 

The following stop codes are contained in this set of tests.

<h3>Data Race between threads</h3>
<p></p><i>Probable cause</i><p>There is a data race in the program.</p><p></p><I>Information displayed by Application Verifier</I><ul>
  <li><b>Format:</b>&nbsp;-&nbsp; API name %08X %ws </li>
...
<p></p><i>Additional Information</i><ul>
  <li><b>Test Layer:</b>&nbsp;Cuzz</li>
  <li><b>Stop ID:</b>&nbsp;DATA_RACE</li>
  <li><b>Stop code:</b>&nbsp;F000000</li>
