---
title: /sos
description: The /sos parameter displays the names of the drivers as they load during the boot process.
ms.assetid: eddeb2b1-af41-4b8f-a211-ab6763bfb2c5
keywords: ["/sos Driver Development Tools"]
topic_type:
- apiref
api_name:
- /sos
...
The **/sos** parameter is supported only on Windows Server 2003, Windows XP, and Windows 2000. On Windows Vista and later versions of Windows, use the **SOS** option with BCDEdit.
