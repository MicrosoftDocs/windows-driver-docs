...
For more information about how to submit your package, see [Submit a Device Metadata Package](https://docs.microsoft.com/windows-hardware/drivers/dashboard/submit-a-device-metadata-package--dashboard-help-).

For more information about the device manifest file, see [Submit a mobile broadband device manifest package](https://docs.microsoft.com/windows-hardware/drivers/dashboard/submit-a-mobile-broadband-device-manifest-package).

For more information about the bulkmetadata file, see [Submit a Bulk Metadata Package](https://docs.microsoft.com/windows-hardware/drivers/dashboard/submit-a-bulk-metadata-package).
