...
For more information about processing WMI minor IRPs, see [**WMI Requirements for WDM Drivers**](../kernel/wmi-requirements-for-wdm-drivers.md), [**Handling WMI Requests**](../kernel/handling-wmi-requests.md), [**Windows Management Instrumentation Routines**](/windows-hardware/drivers/kernel/windows-kernel-mode-wmi-library), and [**WMI Library Support Routines**](/windows-hardware/drivers/kernel/windows-kernel-mode-wmi-library).
