...
The **PendedCompletedRequest** rule specifies that a driver's dispatch routine does not return STATUS\_PENDING on an IRP if the driver has called [**IoCompleteRequest**](/windows-hardware/drivers/ddi/wdm/nf-wdm-iocompleterequest) on the incoming IRP.
...
<tbody>
<tr class="odd">
<td align="left"><p>Run <a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](./static-driver-verifier.md)">Static Driver Verifier</a> and specify the <strong>PendedCompletedRequest</strong> rule.</p>
