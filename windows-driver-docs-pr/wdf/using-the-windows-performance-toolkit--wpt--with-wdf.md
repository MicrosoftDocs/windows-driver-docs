...
-   If you captured a trace on Windows 10 Mobile, you'll need to copy MyPerfTrace.etl from the target device to a computer that has Wpa.exe. You can use the [TShell tool](https://dev.windowsphone.com/OEM/docs/Phone_Testing/TShell) to do this.
