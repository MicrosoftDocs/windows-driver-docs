...
Retrieves the [**DEVICE_OBJECT**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/ns-wdm-_device_object) structure that represents a device's physical device object (PDO). A driver can call this method before the driver has created a framework device object for the device.
...
Returns a pointer to the WDM [**FILE\_OBJECT**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/ns-wdm-_file_object) structure that is associated with a remote I/O target.
...
Returns the WDM [**FILE\_OBJECT**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/ns-wdm-_file_object) structure that is associated with a specified framework file object.
