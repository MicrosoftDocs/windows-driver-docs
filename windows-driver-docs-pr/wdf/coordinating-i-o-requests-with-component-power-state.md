...
:::image type="content" source="images/multicompqueues.png" alt-text="Diagram that shows queue implementation for a multiple component device with request types A, B, and C.":::
