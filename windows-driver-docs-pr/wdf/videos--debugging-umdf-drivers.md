...
-   [Basics and setup](#basics-and-setup)
-   [Examining the object hierarchy with debugger extensions](#examining-the-object-hierarchy-with-debugger-extensions)
-   [Accessing framework USB objects](#accessing-framework-usb-objects)
-   [I/O requests and queues](#-i-o-requests-and-queues)
-   [File objects and callback objects](#file-objects-and-callback-objects)
-   [Tracking I/O requests sent by a UMDF driver](#-tracking-i-o-requests-sent-by-a-umdf-driver)
-   [Driver does not complete an I/O request](#-driver-does-not-complete-an-i-o-request)
