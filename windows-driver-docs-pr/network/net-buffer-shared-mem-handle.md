---
title: NET\_BUFFER\_SHARED\_MEM\_HANDLE macro
description: The NET\_BUFFER\_SHARED\_MEM\_HANDLE macro gets the shared memory handle from a NET\_BUFFER\_SHARED\_MEMORY structure.
MS-HAID:
- 'ndis\_netbuf\_macros\_media\_specific\_b7a5fa69-8617-44a8-b61a-777cb56afc78.xml'
- 'netvista.net\_buffer\_shared\_mem\_handle'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 4bec976b-2cee-405d-889b-b0a3e293840e
keywords: ["NET_BUFFER_SHARED_MEM_HANDLE macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
