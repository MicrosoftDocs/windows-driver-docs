...
-   An [**NDIS\_NIC\_SWITCH\_VF\_INFO\_ARRAY**](ndis-nic-switch-vf-info-array.md) structure that defines the number of elements within the array.

-   An array of [**NDIS\_NIC\_SWITCH\_VF\_INFO**](ndis-nic-switch-vf-info.md) structures. Each of these structures contains information about a single VF on a NIC switch of the network adapter. A VF is attached to a NIC switch through OID method requests of [OID\_NIC\_SWITCH\_ALLOCATE\_VF](oid-nic-switch-allocate-vf.md).

    **Note**  If no VFs are attached to a NIC switch on the network adapter, the **NumElements** member of the [**NDIS\_NIC\_SWITCH\_VF\_INFO\_ARRAY**](ndis-nic-switch-vf-info-array.md) structure is set to zero and no [**NDIS\_NIC\_SWITCH\_VF\_INFO**](ndis-nic-switch-vf-info.md) structures are returned.
...
[**NDIS\_NIC\_SWITCH\_VF\_INFO\_ARRAY**](ndis-nic-switch-vf-info-array.md)
