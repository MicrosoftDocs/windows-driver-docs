---
title: OID\_WDI\_SET\_ADD\_WOL\_PATTERN
description: OID\_WDI\_SET\_ADD\_WOL\_PATTERN adds a wake-on-LAN (WOL) pattern to the firmware.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 96fb71fd-412b-4013-b3bc-c31a43516f55
keywords: ["OID_WDI_SET_ADD_WOL_PATTERN Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
