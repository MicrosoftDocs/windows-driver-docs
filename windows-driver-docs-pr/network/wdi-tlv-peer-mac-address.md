---
title: WDI\_TLV\_PEER\_MAC\_ADDRESS
description: WDI\_TLV\_PEER\_MAC\_ADDRESS is a TLV that contains the MAC address of the peer.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: A936BAA6-96AD-4187-9933-FA02CCFED2AE
keywords: ["WDI_TLV_PEER_MAC_ADDRESS Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
...
| Type                                              | Description                                  |
|---------------------------------------------------|----------------------------------------------|
| [**WDI\_MAC\_ADDRESS**](https://msdn.microsoft.com/library/windows/hardware/dn926071) | Specifies the Wi-Fi MAC address of the peer. |
