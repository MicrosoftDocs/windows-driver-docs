...
**Note**  For information about how NDIS 6.20 and later miniport drivers report power management capabilities, see [Reporting Power Management Capabilities](https://docs.microsoft.com/windows-hardware/drivers/network/reporting-power-management-capabilities).
...
[Reporting Power Management Capabilities](https://docs.microsoft.com/windows-hardware/drivers/network/reporting-power-management-capabilities)
