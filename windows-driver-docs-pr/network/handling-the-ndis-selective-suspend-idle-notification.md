...
:::image type="content" source="images/ndis-ss-idle-notification.png" alt-text="Diagram that shows the steps involved in handling an idle notification by a miniport driver for a USB network adapter.":::
