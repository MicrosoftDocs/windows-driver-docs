...
keywords: 
 -OID_DOT11_MAC_ADDRESS Network Drivers Starting with Windows Vista
---

# OID\_DOT11\_MAC\_ADDRESS
...
When queried, the OID\_DOT11\_MAC\_ADDRESS object identifier (OID) requests that the miniport driver return the value of the IEEE 802.11 **dot11MACAddress** MIB object.

This MIB object contains the media access control (MAC) address currently assigned to the 802.11 station.

The data type for OID\_DOT11\_MAC\_ADDRESS is the [**DOT11\_MAC\_ADDRESS**](https://msdn.microsoft.com/library/windows/hardware/ff548681) structure.
