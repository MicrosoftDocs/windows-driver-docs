...
-   The WSK application allocates the IRP by calling the [**IoAllocateIrp**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/nf-wdm-ioallocateirp) function. In this situation, the WSK application must allocate the IRP with at least one I/O stack location.

-   The WSK application reuses a completed IRP that it previously allocated. In this situation, the WSK must call the [**IoReuseIrp**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/nf-wdm-ioreuseirp) function to reinitialize the IRP.
