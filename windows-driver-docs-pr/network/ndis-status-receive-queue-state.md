...
MS-HAID:
- 'virtual\_machine\_queue\_ref\_099f6c7e-3966-40d5-843e-99d82b49e905.xml'
- 'netvista.ndis\_status\_receive\_queue\_state'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 59b42de9-6aa5-445e-a39a-de2421c945ea
keywords: ["NDIS_STATUS_RECEIVE_QUEUE_STATE Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
