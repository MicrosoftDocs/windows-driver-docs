---
title: WDI\_TLV\_P2P\_INSTANCE\_NAME\_HASH
description: WDI\_TLV\_P2P\_INSTANCE\_NAME\_HASH is a TLV that contains the hash of \ 0034;Instance Name, Service Type \ 0034;.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: A29D0339-93A8-43EB-8C22-DD7A7DC2147C
keywords: ["WDI_TLV_P2P_INSTANCE_NAME_HASH Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
