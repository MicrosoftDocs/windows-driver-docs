...
> [!NOTE] 
> NDIS LWF drivers cannot attach to adapters that have nolower in their **LowerRange** of their INF file. NDIS LWF drivers are not allowed to have nolower in their FilterMediaTypes.
