...
MS-HAID:
- 'WwanRef\_96947f54-1e9b-45ce-8f45-5703cb9147fb.xml'
- 'netvista.ndis\_status\_wwan\_device\_caps'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: e21e2928-c50d-4dec-a575-7e306fecf20f
keywords: ["NDIS_STATUS_WWAN_DEVICE_CAPS Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
