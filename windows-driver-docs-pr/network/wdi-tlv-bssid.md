---
title: WDI\_TLV\_BSSID
description: WDI\_TLV\_BSSID is a TLV that contains the BSSID of a BSS.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 0B3AB317-D1E7-4E61-9F6E-C3134B5A3984
keywords: ["WDI_TLV_BSSID Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
- WDI_TLV_BSSID
