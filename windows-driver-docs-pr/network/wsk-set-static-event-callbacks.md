...
MS-HAID:
- 'wskref\_9a239940-4cf2-4640-bb2a-e18aad9797cb.xml'
- 'netvista.wsk\_set\_static\_event\_callbacks'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: fa95bc7d-c7b2-4cca-a419-ef5eb2520976
keywords: ["WSK_SET_STATIC_EVENT_CALLBACKS Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
