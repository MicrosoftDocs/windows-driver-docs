...
:::image type="content" source="images/apiflow3.png" alt-text="Diagram showing the process of Windows Sockets switch requesting a connection with a remote peer.":::
