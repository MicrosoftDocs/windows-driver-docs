...
The data type for this indication is the [**DOT11\_PHY\_FREQUENCY\_ADOPTED\_PARAMETERS**](dot11-phy-frequency-adopted-parameters.md) structure.
...
The miniport driver calls [**NdisMIndicateStatusEx**](ndismindicatestatusex.md) to make an NDIS\_STATUS\_DOT11\_PHY\_FREQUENCY\_ADOPTED indication, and must pass a pointer to an [**NDIS\_STATUS\_INDICATION**](ndis-status-indication.md) structure through the *StatusIndication* parameter. When the driver makes this indication, it must set the following members of the NDIS\_STATUS\_INDICATION structure:
...
[**DOT11\_PHY\_FREQUENCY\_ADOPTED\_PARAMETERS**](dot11-phy-frequency-adopted-parameters.md)
