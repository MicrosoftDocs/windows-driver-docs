---
title: WDI\_TLV\_WAKE\_PACKET\_EAPOL\_REQUEST\_ID\_MESSAGE
author: windows-driver-content
description: WDI\_TLV\_WAKE\_PACKET\_EAPOL\_REQUEST\_ID\_MESSAGE is a TLV that contains the wake-on-LAN pattern ID of a EAPOL request ID message.
