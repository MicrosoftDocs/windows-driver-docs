...
NDIS issues this OID with the **InformationBuffer** member of the [**NDIS\_OID\_REQUEST**](ndis-oid-request.md) structure pointing to an [**NDIS\_NDK\_STATISTICS\_INFO**](ndis-ndk-statistics-info.md) structure.

The NDK-capable miniport driver must provide the **CounterSet** member, which is a [**NDIS\_NDK\_PERFORMANCE\_COUNTERS**](ndis-ndk-performance-counters.md) structure.
...
[**NDIS\_NDK\_PERFORMANCE\_COUNTERS**](ndis-ndk-performance-counters.md)

[**NDIS\_NDK\_STATISTICS\_INFO**](ndis-ndk-statistics-info.md)
