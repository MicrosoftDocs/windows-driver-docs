...
-   A call to the driver's [*MiniportInitializeEx*](https://msdn.microsoft.com/library/windows/hardware/ff559389) function. In this situation, the driver can set the **dot11CurrentRegDomain** MIB object to a default regulatory domain based on configuration parameters from the system registry.
