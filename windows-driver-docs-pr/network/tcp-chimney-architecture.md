...
keywords: ["TCP chimney offload WDK networking , architecture", "chimney offload WDK networking , architecture", "data I/O interface WDK TCP chimney offload", "state-manipulation interface WDK TCP chimney offload", "event indication interface WDK TCP chimney offload", "interfaces WDK TCP chimney offload", "host stacks WDK TCP chimney offload"]
---
