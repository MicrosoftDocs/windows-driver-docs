...
keywords: ["network drivers WDK , architecture", "architecture WDK networking", "kernel-mode drivers WDK , network architecture", "network architecture WDK"]
---

# Network Architecture for Kernel-Mode Drivers


## <a href="" id="ddk-network-architecture-for-kernel-mode-drivers-ng"></a>
