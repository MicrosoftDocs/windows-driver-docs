...
MS-HAID:
- 'ndis\_status\_indications\_ref\_5fe3b9da-3484-44f9-b929-3b609ae50bf3.xml'
- 'netvista.ndis\_status\_packet\_filter'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 7633772a-cd3d-4030-b97a-9d503341fdeb
keywords: ["NDIS_STATUS_PACKET_FILTER Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
