...
NDIS interface providers provide an [**NDIS\_INTERFACE\_INFORMATION**](/windows/win32/api/ifdef/ns-ifdef-_ndis_interface_information) structure in response to a query of the [OID\_GEN\_INTERFACE\_INFO](./oid-gen-interface-info.md) OID.
