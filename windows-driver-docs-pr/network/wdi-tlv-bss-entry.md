---
title: WDI\_TLV\_BSS\_ENTRY
description: WDI\_TLV\_BSS\_ENTRY is a TLV that contains BSS entry information.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 1D3AAB94-9FCE-4243-994A-7195440DDFCA
keywords: ["WDI_TLV_BSS_ENTRY Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
- WDI_TLV_BSS_ENTRY
