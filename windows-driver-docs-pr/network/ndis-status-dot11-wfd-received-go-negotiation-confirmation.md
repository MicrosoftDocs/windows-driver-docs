---
title: NDIS\_STATUS\_DOT11\_WFD\_RECEIVED\_GO\_NEGOTIATION\_CONFIRMATION
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: D5FF9BDD-D359-40A1-9076-518296ECE3A4
description: 
keywords: ["NDIS_STATUS_DOT11_WFD_RECEIVED_GO_NEGOTIATION_CONFIRMATION Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
