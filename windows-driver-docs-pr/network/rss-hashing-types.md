...
If this flag combination is set, the NIC should perform the hash calculations as specified for the NDIS_HASH_TCP_IPV4 case.
...
<a href="" id="ndis-hash-ipv6"></a>NDIS_HASH_IPV6  
...
<a href="" id="ndis-hash-tcp-ipv6"></a>NDIS_HASH_TCP_IPV6
...
<a href="" id="ndis-hash-tcp-ipv6---ndis-hash-ipv6"></a>NDIS_HASH_TCP_IPV6 | NDIS_HASH_IPV6
If this flag combination is set, the NIC should perform the hash calculations as specified for the NDIS_HASH_TCP_IPV6 case.
...
<a href="" id="ndis-hash-ipv6-ex"></a>NDIS_HASH_IPV6_EX  
If this flag alone is set, the NIC should compute the hash over the following fields:
...
<a href="" id="ndis-hash-tcp-ipv6-ex"></a>NDIS_HASH_TCP_IPV6_EX
If this flag alone is set, the NIC should compute the hash over the following fields:
...
<a href="" id="ndis-hash-tcp-ipv6-ex---ndis-hash-ipv6-ex"></a>NDIS_HASH_TCP_IPV6_EX | NDIS_HASH_IPV6_EX
If this flag combination is set, the NIC should perform the hash calculations as specified for the NDIS_HASH_TCP_IPV6_EX case.
