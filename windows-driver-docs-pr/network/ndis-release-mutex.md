...
MS-HAID:
- 'ndis\_interrupts\_sync\_macros\_ref\_5df6377b-6866-4247-81d1-7f306b0d11ee.xml'
- 'netvista.ndis\_release\_mutex'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 0358f584-c1a2-4462-8294-09504eb18b17
keywords: ["NDIS_RELEASE_MUTEX macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
- NDIS_RELEASE_MUTEX
