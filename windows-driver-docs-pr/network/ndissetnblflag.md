...
MS-HAID:
- 'ndis\_netbuf\_macros\_nblflags\_ref\_49a624eb-0dc0-4c5e-8969-57fe71814656.xml'
- 'netvista.ndissetnblflag'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 0a92b689-fe82-4ac6-a674-5e249dd8e1f1
keywords: ["NdisSetNblFlag macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
- NdisSetNblFlag
