...
The data type for OID\_DOT11\_WFD\_SEND\_GO\_NEGOTIATION\_RESPONSE is the [**DOT11\_SEND\_GO\_NEGOTIATION\_RESPONSE\_PARAMETERS**](dot11-send-go-negotiation-response-parameters.md) structure.
