...
OID_WWAN_UICC_RESET is sent by the mobile broadband host to a modem miniport driver instance to reset its UICC smart card, or query the passthrough state of the driver instance's UICC.
