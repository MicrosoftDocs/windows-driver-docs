...
If the query succeeds, the interface provider returns NDIS\_STATUS\_SUCCESS, and the result of the query is an [**NDIS\_INTERFACE\_INFORMATION**](ndis-interface-information-str.md) structure. This structure contains information that changes during the lifetime of the interface.
...
[**NDIS\_INTERFACE\_INFORMATION**](ndis-interface-information-str.md)
