...
> [!IMPORTANT]
> This section's header topics contains pages for definitions, macros, OIDs, and other data structures that are not part of standard network driver reference. For more information about standard network driver reference for these headers (structures, enumerations, functions, callbacks, and IOCTLs), see [SDK Topics for Network Drivers (Reference)](https://msdn.microsoft.com/library/windows/hardware/mt808525).

This section contains:

- Insert header topics here
