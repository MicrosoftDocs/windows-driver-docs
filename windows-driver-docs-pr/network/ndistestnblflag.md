...
description: The NdisTestNblFlag macro retrieves the current setting of a flag in a NET\_BUFFER\_LIST structure.
MS-HAID:
- 'ndis\_netbuf\_macros\_nblflags\_ref\_46402829-bf69-4069-b560-b80a1aec7b08.xml'
- 'netvista.ndistestnblflag'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 098e5ab4-82af-423a-82ce-65be7e6d853c
keywords: ["NdisTestNblFlag macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
- NdisTestNblFlag
