...
MS-HAID:
- 'ndis\_status\_indications\_ref\_4693377a-fb77-463b-96a2-f72cc365f868.xml'
- 'netvista.ndis\_status\_port\_state'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 28e76963-af06-4a00-83ef-14e009cf35ec
keywords: ["NDIS_STATUS_PORT_STATE Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
