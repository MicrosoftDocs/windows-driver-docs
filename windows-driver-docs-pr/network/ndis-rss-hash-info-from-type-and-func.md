...
MS-HAID:
- 'receive\_scaling\_macros\_ref\_161b68bb-77a9-4d17-9073-f3c763b15c32.xml'
- 'netvista.ndis\_rss\_hash\_info\_from\_type\_and\_func'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: c29e3963-d8d0-459d-89ca-1d1a4cf4921f
keywords: ["NDIS_RSS_HASH_INFO_FROM_TYPE_AND_FUNC macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
