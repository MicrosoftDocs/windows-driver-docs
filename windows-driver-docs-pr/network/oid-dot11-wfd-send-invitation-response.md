...
The data type for OID\_DOT11\_WFD\_SEND\_INVITATION\_RESPONSE is the [**DOT11\_SEND\_INVITATION\_RESPONSE\_PARAMETERS**](dot11-send-invitation-response-parameters.md) structure.
...
[**DOT11\_SEND\_INVITATION\_RESPONSE\_PARAMETERS**](dot11-send-invitation-response-parameters.md)
