...
When a packet is transmitted, the miniport driver attaches the timestamp generated in hardware to the NBL before the NBL is send completed to NDIS by calling the [**NdisMSendNetBufferListsComplete**](/windows-hardware/drivers/ddi/ndis/nf-ndis-ndismsendnetbufferlistscomplete) function.
