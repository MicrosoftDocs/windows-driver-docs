---
title: NDIS\_STATUS\_HD\_SPLIT\_CURRENT\_CONFIG
description: Miniport drivers use the NDIS\_STATUS\_HD\_SPLIT\_CURRENT\_CONFIG status indication to notify NDIS and overlying drivers that there has been a change in the header-data split configuration of a miniport adapter.
MS-HAID:
- 'header\_data\_split\_ref\_43b24c2d-7d05-492a-90cf-176d332e389b.xml'
- 'netvista.ndis\_status\_hd\_split\_current\_config'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 6605d888-bcbe-4898-aa25-4a4352fc50de
keywords: ["NDIS_STATUS_HD_SPLIT_CURRENT_CONFIG Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
