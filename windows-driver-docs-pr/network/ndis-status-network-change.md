...
MS-HAID:
- 'ndis\_status\_indications\_ref\_b701747f-65b1-43b8-ad49-ed8b6c2e6b4c.xml'
- 'netvista.ndis\_status\_network\_change'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: feb6bb71-7147-43dd-b09d-cb41404164eb
keywords: ["NDIS_STATUS_NETWORK_CHANGE Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
