...
MS-HAID:
- 'receive\_scaling\_macros\_ref\_663d4c1f-aeb8-4d4a-a2fd-f2b24b990546.xml'
- 'netvista.net\_buffer\_list\_get\_hash\_type'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 96a6e299-f3f4-456d-be5e-1c4e6ec98aa4
keywords: ["NET_BUFFER_LIST_GET_HASH_TYPE macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
