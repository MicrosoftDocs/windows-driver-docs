...
MS-HAID:
- 'wskref\_fbcec796-2abc-4ad8-a5a2-c6bac881978b.xml'
- 'netvista.wsk\_transport\_list\_query'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: feb6aed2-fac9-4d3f-a36b-f721c737aacf
keywords: ["WSK_TRANSPORT_LIST_QUERY Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
