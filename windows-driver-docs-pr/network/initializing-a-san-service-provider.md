...
:::image type="content" source="images/apiflow1.png" alt-text="Diagram illustrating the initialization process of a SAN service provider by the Windows Sockets switch.":::
