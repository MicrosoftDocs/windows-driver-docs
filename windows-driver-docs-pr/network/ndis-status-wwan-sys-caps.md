---
title: NDIS\_STATUS\_WWAN\_SYS\_CAPS\_INFO
description: Miniport drivers use the NDIS\_STATUS\_WWAN\_SYS\_CAPS\_INFO notification to inform the MB service about the completion of a previous OID\_WWAN\_SYS\_CAPS\_INFO query request.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 653A35EC-29BB-458D-B33C-41EF6EF47A6E
keywords: ["NDIS_STATUS_WWAN_SYS_CAPS_INFO Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
