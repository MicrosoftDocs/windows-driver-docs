...
**Note**  It is also possible to perform this query in a user-mode application by using [**SIO\_QUERY\_WFP\_CONNECTION\_REDIRECT\_RECORDS (SDK)**](/previous-versions/windows/desktop/legacy/hh859713(v=vs.85)).
...
[**SIO\_QUERY\_WFP\_CONNECTION\_REDIRECT\_RECORDS (SDK)**](/previous-versions/windows/desktop/legacy/hh859713(v=vs.85))
