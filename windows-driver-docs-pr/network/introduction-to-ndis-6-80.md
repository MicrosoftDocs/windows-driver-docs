...
An NDIS 6.80 driver must follow the requirements that are defined in [Implementing an NDIS 6.70 driver](introduction-to-ndis-6-60.md#implementing-an-ndis-670-driver).
