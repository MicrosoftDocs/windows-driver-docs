...
MS-HAID:
- 'ndis\_mdl\_ref\_9790592d-2af0-46f7-8a9b-c43a472d0b85.xml'
- 'netvista.ndisquerymdloffset'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: d6f23e9c-5015-4087-b7a2-badee00bdafa
keywords: ["NdisQueryMdlOffset macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
- NdisQueryMdlOffset
