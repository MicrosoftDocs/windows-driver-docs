---
title: WDI\_TLV\_AP\_BAND\_CHANNEL
description: WDI\_TLV\_AP\_BAND\_CHANNEL is a TLV that specifies access point band and channel information.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 5659CFA1-7FA9-490D-83DE-A56A895602A0
keywords: ["WDI_TLV_AP_BAND_CHANNEL Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
