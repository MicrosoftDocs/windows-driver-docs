...
When OID\_DOT11\_SUPPORTED\_TX\_ANTENNA is queried, the miniport driver must verify that the **InformationBuffer** member of the [*MiniportOidRequest*](miniportoidrequest.md) function's *OidRequest* parameter is large enough to return the list of supported transmit antennas. For more information about the procedure that verifies the size of the **InformationBuffer** member, see [**DOT11\_SUPPORTED\_ANTENNA\_LIST**](dot11-supported-antenna-list.md).
