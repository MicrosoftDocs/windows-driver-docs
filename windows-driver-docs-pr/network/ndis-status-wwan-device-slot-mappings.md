---
title: NDIS\_STATUS\_WWAN\_DEVICE\_SLOT\_MAPPING\_INFO
description: Miniport drivers use the NDIS\_STATUS\_WWAN\_DEVICE\_SLOT\_MAPPING\_INFO notification to inform the MB service about the completion of a previous OID\_WWAN\_DEVICE\_SLOT\_MAPPING\_INFO query or set request.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 7825C20E-FB56-420D-B516-1ADA0C7C382E
keywords: ["NDIS_STATUS_WWAN_DEVICE_SLOT_MAPPING_INFO Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
