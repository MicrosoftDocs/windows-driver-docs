...
:::image type="content" source="images/esim_lpa_block.png" alt-text="Diagram that shows the eSIM architecture with LPA Service and WWAN Service components.":::
...
:::image type="content" source="images/esim_lpa_init.png" alt-text="Flowchart illustrating the eSIM service initialization process.":::

## eSIM Profile Download and Install

:::image type="content" source="images/esim_lpa_download_install.png" alt-text="Flowchart depicting the eSIM profile download and installation process.":::
...
:::image type="content" source="images/esim_lpa_enable.png" alt-text="Flowchart demonstrating the eSIM enable profile operation with sample commands.":::
