...
MS-HAID:
- 'receive\_scaling\_macros\_ref\_13d7acde-7e1b-4b15-9980-80468328a834.xml'
- 'netvista.net\_buffer\_list\_get\_hash\_function'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: bb80344c-8f82-4446-9f6f-8c2d4cabfd5a
keywords: ["NET_BUFFER_LIST_GET_HASH_FUNCTION macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
