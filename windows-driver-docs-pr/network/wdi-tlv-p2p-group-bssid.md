---
title: WDI\_TLV\_P2P\_GROUP\_BSSID
description: WDI\_TLV\_P2P\_GROUP\_BSSID is a TLV that contains the Group BSSID for local Wi-Fi Direct GO.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: C9BC2209-DF72-4775-A3B5-EC37D404CFED
keywords: ["WDI_TLV_P2P_GROUP_BSSID Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
