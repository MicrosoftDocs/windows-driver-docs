...
MS-HAID:
- 'wskref\_3e7c1d18-97f6-4e89-b873-e04e2299ea86.xml'
- 'netvista.so\_wsk\_event\_callback'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: cb697103-20ef-4667-8823-060a68d904c8
keywords: ["SO_WSK_EVENT_CALLBACK Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
