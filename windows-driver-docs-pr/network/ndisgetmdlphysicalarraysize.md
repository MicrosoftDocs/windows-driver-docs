...
MS-HAID:
- 'ndis\_mdl\_ref\_1f6f2fca-a679-4782-9a05-31a7f68d8f5f.xml'
- 'netvista.ndisgetmdlphysicalarraysize'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 25e3f9a3-3057-4081-af74-427102197906
keywords: ["NdisGetMdlPhysicalArraySize macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
