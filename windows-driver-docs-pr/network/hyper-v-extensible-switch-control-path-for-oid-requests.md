...
:::image type="content" source="images/vswitch-oid-controlpath-ndis640.png" alt-text="Diagram showing the Hyper-V extensible switch OID control path for NDIS 6.40 (Windows Server 2012 R2) and later.":::

The following figure shows the extensible switch control path for OID requests for NDIS 6.30 (Windows Server 2012).

:::image type="content" source="images/vswitch-oid-controlpath.png" alt-text="Diagram showing the Hyper-V extensible switch OID control path for NDIS 6.30 (Windows Server 2012).":::
