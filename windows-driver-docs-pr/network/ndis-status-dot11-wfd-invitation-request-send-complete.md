---
title: NDIS\_STATUS\_DOT11\_WFD\_INVITATION\_REQUEST\_SEND\_COMPLETE
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 8BAD2F9D-F518-43DF-A7DE-95E707EAB5D5
description: 
keywords: ["NDIS_STATUS_DOT11_WFD_INVITATION_REQUEST_SEND_COMPLETE Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
