...
:::image type="content" source="images/wdi-dx-to-d0-armed-to-wake.png" alt-text="Flowchart illustrating the transition from Dx (armed to wake) to D0 for the device.":::
...
:::image type="content" source="images/wdi-dx-to-d0-not-armed.png" alt-text="Flowchart showing the transition from Dx (not armed to wake) to D0 for the device.":::
