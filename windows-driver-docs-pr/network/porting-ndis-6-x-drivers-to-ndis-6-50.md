...
If you are porting an NDIS 6.x driver to NDIS 6.50, you should be familar with the changes to each version between your driver's version and 6.50. For more information about previous NDIS 6.x versions, see the following topics:
