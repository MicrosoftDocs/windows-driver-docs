...
A pointer to an [**NDIS\_SWITCH\_PORT\_PROPERTY\_ROUTING\_DOMAIN**](ndis-switch-port-property-routing-domain.md) structure.

Return value
------------

The **NDIS\_SWITCH\_PORT\_PROPERTY\_ROUTING\_DOMAIN\_GET\_FIRST\_ISOLATION\_ENTRY** macro returns a pointer to the first [**NDIS\_ROUTING\_DOMAIN\_ISOLATION\_ENTRY**](ndis-routing-domain-isolation-entry.md).
