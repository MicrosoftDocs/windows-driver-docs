...
:::image type="content" source="images/vswitch-status-controlpath2-ndis640.png" alt-text="Diagram that shows the Hyper-V extensible switch control path for NDIS status indications from physical network adapters for NDIS 6.40 (Windows Server 2012 R2) and later.":::
...
:::image type="content" source="images/vswitch-status-controlpath2.png" alt-text="Diagram that shows the Hyper-V extensible switch control path for NDIS status indications from physical network adapters for NDIS 6.30 (Windows Server 2012).":::
