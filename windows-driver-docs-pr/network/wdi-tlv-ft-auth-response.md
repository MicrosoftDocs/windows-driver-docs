---
title: WDI\_TLV\_FT\_AUTH\_RESPONSE
description: WDI\_TLV\_FT\_AUTH\_RESPONSE is a TLV that contains the Fast Transition authentication response byte blob.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: BF9B37B4-EC5D-46AA-B334-C1214310964B
keywords: ["WDI_TLV_FT_AUTH_RESPONSE Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
