...
An overlying driver issues an OID query request of OID_QOS_OFFLOAD_HARDWARE_CAPABILITIES to obtain the Virtual Machine Quality of Service (vmQoS) offload hardware capabilities of a miniport adapter.
