...
MS-HAID:
- 'ndis\_netbuf\_macros\_media\_specific\_ab133d1e-b69e-4544-85f8-5cd3d6067957.xml'
- 'netvista.net\_buffer\_shared\_mem\_offset'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 7610238b-631b-414d-85ca-6b90c320dfbf
keywords: ["NET_BUFFER_SHARED_MEM_OFFSET macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
