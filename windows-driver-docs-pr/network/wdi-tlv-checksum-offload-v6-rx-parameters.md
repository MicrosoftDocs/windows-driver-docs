---
title: WDI\_TLV\_CHECKSUM\_OFFLOAD\_V6\_RX\_PARAMETERS (0xDD)
description: WDI\_TLV\_CHECKSUM\_OFFLOAD\_V6\_RX\_PARAMETERS is a TLV that contains for Rx checksum offload for IPv6.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: F647B2B6-F535-4AE2-B7A9-DF08AADB2A95
keywords: ["WDI_TLV_CHECKSUM_OFFLOAD_V6_RX_PARAMETERS (0xDD) Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
