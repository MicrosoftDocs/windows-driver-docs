---
title: WDI\_TLV\_OPERATION\_MODE
description: WDI\_TLV\_OPERATION\_MODE is a TLV that contains the desired operation mode.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: CF5D9148-E50B-4F39-B37C-2495DE9A1488
keywords: ["WDI_TLV_OPERATION_MODE Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
