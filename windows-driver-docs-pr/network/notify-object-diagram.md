...
:::image type="content" source="images/netcfg.png" alt-text="Diagram illustrating the interaction between client applications, network configuration subsystem, network class installers, and notify objects in a networking context.":::
