...
-   An [**NDIS\_SRIOV\_WRITE\_VF\_CONFIG\_BLOCK\_PARAMETERS**](ndis-sriov-write-vf-config-block-parameters.md) structure that contains the offset, in units of bytes, from the beginning of this structure to a location within the buffer that contains the data that is written to the VF configuration block.
...
Before it issues the OID set request of OID\_SRIOV\_WRITE\_VF\_CONFIG\_BLOCK, the overlying driver must set the members of [**NDIS\_SRIOV\_WRITE\_VF\_CONFIG\_BLOCK\_PARAMETERS**](ndis-sriov-write-vf-config-block-parameters.md) structure in the following way:
...
-   The PF miniport driver must verify that the VF, specified by the **VFId** member of the [**NDIS\_SRIOV\_WRITE\_VF\_CONFIG\_BLOCK\_PARAMETERS**](ndis-sriov-write-vf-config-block-parameters.md) structure, has resources that have been previously allocated. The PF miniport driver allocates resources for a VF during an OID method request of [OID\_NIC\_SWITCH\_ALLOCATE\_VF](oid-nic-switch-allocate-vf.md). If resources for the specified VF have not been allocated, the driver must fail the OID request.

-   The PF miniport driver must verify that the **BlockId** member of the [**NDIS\_SRIOV\_WRITE\_VF\_CONFIG\_BLOCK\_PARAMETERS**](ndis-sriov-write-vf-config-block-parameters.md) structure specifies a valid VF configuration block. If not, the driver must fail the OID request.
...
<td><p>One or more of the members of the [<strong>NDIS_SRIOV_WRITE_VF_CONFIG_BLOCK_PARAMETERS</strong>](ndis-sriov-write-vf-config-block-parameters.md) structure have invalid values.</p></td>
</tr>
<tr class="even">
...
[**NDIS\_SRIOV\_WRITE\_VF\_CONFIG\_BLOCK\_PARAMETERS**](ndis-sriov-write-vf-config-block-parameters.md)
