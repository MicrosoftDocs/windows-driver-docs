...
MS-HAID:
- 'receive\_scaling\_macros\_ref\_d6924530-a1d0-4671-8f6c-e2ccfbe6eaf3.xml'
- 'netvista.net\_buffer\_list\_set\_hash\_function'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 01257316-b037-4e7a-8084-d2cc8ad2a55a
keywords: ["NET_BUFFER_LIST_SET_HASH_FUNCTION macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
