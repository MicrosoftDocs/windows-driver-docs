...
As a query, NDIS and overlying drivers use the OID\_GEN\_RECEIVE\_HASH OID to obtain the current receive hash calculation settings of a miniport adapter. NDIS returns an [**NDIS\_RECEIVE\_HASH\_PARAMETERS**](ndis-receive-hash-parameters.md) structure that contains the current receive hash settings.
...
**Note**  The secret key is appended after the [**NDIS\_RECEIVE\_HASH\_PARAMETERS**](ndis-receive-hash-parameters.md) structure members.
...
[**NDIS\_RECEIVE\_HASH\_PARAMETERS**](ndis-receive-hash-parameters.md)
