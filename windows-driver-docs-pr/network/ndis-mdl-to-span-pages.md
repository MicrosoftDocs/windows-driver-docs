...
MS-HAID:
- 'ndis\_mdl\_ref\_9e5734b5-f377-4d1b-b887-039a9ca064a6.xml'
- 'netvista.ndis\_mdl\_to\_span\_pages'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 8c9df989-4a5f-4ec1-9544-29b59517a502
keywords: ["NDIS_MDL_TO_SPAN_PAGES macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
