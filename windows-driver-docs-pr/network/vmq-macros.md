...
description: VMQ Macros
ms.assetid: 7E90D97A-2F6D-4770-8AC3-A6899F578EB1
...
This section includes the following virtual machine queue (VMQ) macros:

[**NET\_BUFFER\_LIST\_RECEIVE\_QUEUE\_ID**](net-buffer-list-receive-queue-id.md)
