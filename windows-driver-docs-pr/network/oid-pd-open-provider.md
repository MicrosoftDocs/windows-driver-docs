...
-   An [**NDIS\_PD\_OPEN\_PROVIDER\_PARAMETERS**](ndis-pd-open-provider-parameters.md) structure
...
[**NDIS\_PD\_OPEN\_PROVIDER\_PARAMETERS**](ndis-pd-open-provider-parameters.md)
