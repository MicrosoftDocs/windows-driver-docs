---
title: NDIS\_STATUS\_WDI\_INDICATION\_CREATE\_PORT\_COMPLETE
description: Miniport drivers use NDIS\_STATUS\_WDI\_INDICATION\_CREATE\_PORT\_COMPLETE to indicate the completion of OID\_WDI\_TASK\_CREATE\_PORT.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 8d3cdac1-06d3-4a21-ac13-e6d789c6922e
keywords: ["NDIS_STATUS_WDI_INDICATION_CREATE_PORT_COMPLETE Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
