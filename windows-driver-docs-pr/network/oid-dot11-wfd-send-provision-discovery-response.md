...
The data type for OID\_DOT11\_WFD\_SEND\_PROVISION\_DISCOVERY\_RESPONSE is the [**DOT11\_SEND\_PROVISION\_DISCOVERY\_RESPONSE\_PARAMETERS**](dot11-send-provision-discovery-response-parameters.md) structure.
...
[**DOT11\_SEND\_PROVISION\_DISCOVERY\_RESPONSE\_PARAMETERS**](dot11-send-provision-discovery-response-parameters.md)
