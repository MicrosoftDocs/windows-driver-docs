...
MS-HAID:
- 'miniport\_power\_management\_ref\_1767746a-bc66-4f65-8588-942121894d43.xml'
- 'netvista.ndis\_6\_20\_power\_management\_status\_indications'
- 'netvista.power\_management\_status\_indications'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: f6a8fef7-2bdd-42b1-8afa-c93a7d6dcce6
keywords: ["NDIS 6.20 WDK , power management status indications", "power management WDK networking NDIS 6.20 status indications", "power management WDK NDIS 6.20 , status indications"]
---
