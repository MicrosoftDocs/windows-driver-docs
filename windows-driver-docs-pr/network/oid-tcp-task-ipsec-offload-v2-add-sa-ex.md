...
This OID is essentially identical to the previous version, [OID\_TCP\_TASK\_IPSEC\_OFFLOAD\_V2\_ADD\_SA](oid-tcp-task-ipsec-offload-v2-add-sa.md). The only difference is the updated [**IPSEC\_OFFLOAD\_V2\_ADD\_SA\_EX**](ipsec-offload-v2-add-sa-ex.md) structure.
...
[**IPSEC\_OFFLOAD\_V2\_ADD\_SA\_EX**](ipsec-offload-v2-add-sa-ex.md)
