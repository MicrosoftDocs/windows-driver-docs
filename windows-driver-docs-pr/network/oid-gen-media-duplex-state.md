...
If the query succeeds, the interface provider returns NDIS\_STATUS\_SUCCESS, and the result of the query can be one of the values in the [**NET\_IF\_MEDIA\_DUPLEX\_STATE**](/windows/win32/api/ifdef/ne-ifdef-_net_if_media_duplex_state) enumeration.
...
[**NET\_IF\_MEDIA\_DUPLEX\_STATE**](/windows/win32/api/ifdef/ne-ifdef-_net_if_media_duplex_state)
