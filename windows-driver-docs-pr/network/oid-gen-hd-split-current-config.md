---
title: OID\_GEN\_HD\_SPLIT\_CURRENT\_CONFIG
...
The **InformationBuffer** member of the [**NDIS\_OID\_REQUEST**](ndis-oid-request.md) structure contains an [**NDIS\_HD\_SPLIT\_CURRENT\_CONFIG**](ndis-hd-split-current-config.md) structure.
...
[**NDIS\_HD\_SPLIT\_CURRENT\_CONFIG**](ndis-hd-split-current-config.md)
