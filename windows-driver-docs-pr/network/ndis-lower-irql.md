...
MS-HAID:
- 'ndis\_interrupts\_sync\_macros\_ref\_1fb7081b-8195-4790-b97b-9de330a6277b.xml'
- 'netvista.ndis\_lower\_irql'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: fd6b57a1-cd6f-4d30-b2b6-0c9842706855
keywords: ["NDIS_LOWER_IRQL macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
- NDIS_LOWER_IRQL
