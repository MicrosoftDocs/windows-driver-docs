---
title: WDI\_TLV\_SET\_ENCAPSULATION\_OFFLOAD\_V6\_PARAMETERS
description: WDI\_TLV\_SET\_ENCAPSULATION\_OFFLOAD\_V6\_PARAMETERS is a TLV that is used by OID\_WDI\_SET\_ENCAPSULATION\_OFFLOAD to indicate if IPv6 offloading should be started.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 7036AFD0-197E-4A94-8580-A42889BE6798
keywords: ["WDI_TLV_SET_ENCAPSULATION_OFFLOAD_V6_PARAMETERS Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
