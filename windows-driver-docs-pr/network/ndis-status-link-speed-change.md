...
MS-HAID:
- 'ndis\_status\_indications\_ref\_030b717a-a3ae-4d61-a9d8-de41d4df7b7e.xml'
- 'netvista.ndis\_status\_link\_speed\_change'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 084e43c9-598c-4c30-8004-2d1876a1cddd
keywords: ["NDIS_STATUS_LINK_SPEED_CHANGE Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
