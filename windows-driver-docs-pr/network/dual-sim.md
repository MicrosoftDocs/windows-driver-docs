...
For more information about configuring C + G, see [Configure C+G dual SIM settings](https://docs.microsoft.com/windows-hardware/customize/mobile/mcsf/configure-c-g-dual-sim-settings).
