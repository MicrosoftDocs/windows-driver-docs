---
title: NDIS\_STATUS\_WWAN\_USSD
description: Miniport drivers use the NDIS\_STATUS\_WWAN\_USSD notification to implement the transaction completion response for Unstructured Supplementary Service Data (USSD) operations with the NDIS\_WWAN\_USSD\_REQUEST structure.Miniport drivers can also send unsolicited events with this notification using the NDIS\_WWAN\_USSD\_EVENT structure to describe the nature of the USSD event.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 6EE1235A-486E-4653-BFAC-6151C795676B
keywords: ["NDIS_STATUS_WWAN_USSD Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
