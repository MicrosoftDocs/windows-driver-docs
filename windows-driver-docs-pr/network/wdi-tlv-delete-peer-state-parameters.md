---
title: WDI\_TLV\_DELETE\_PEER\_STATE\_PARAMETERS
description: WDI\_TLV\_DELETE\_PEER\_STATE\_PARAMETERS is an unused TLV.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 784FC7E3-8922-44D1-B46D-BEC6CE7EF3EF
keywords: ["WDI_TLV_DELETE_PEER_STATE_PARAMETERS Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
- WDI_TLV_DELETE_PEER_STATE_PARAMETERS
api_location:
- wditypes.hpp
api_type:
- HeaderDef
