...
MS-HAID:
- 'ndis\_interrupts\_sync\_macros\_ref\_5fc57533-f2ee-40c1-bb9a-37948945b23d.xml'
- 'netvista.ndis\_wait\_for\_mutex'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: eaa323cc-4a17-4e94-8779-16efa079c5c4
keywords: ["NDIS_WAIT_FOR_MUTEX macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
- NDIS_WAIT_FOR_MUTEX
