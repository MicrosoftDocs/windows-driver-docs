...
MS-HAID:
- 'ndis\_netbuf\_macros\_ref\_5d12ffb3-1fa5-4b86-9c7d-1026640b25de.xml'
- 'netvista.net\_buffer\_next\_nb'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 2c9bf3eb-4aa9-4983-91a8-c78f100b2d5f
keywords: ["NET_BUFFER_NEXT_NB macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
- NET_BUFFER_NEXT_NB
