---
title: NET\_BUFFER\_SHARED\_MEM\_NEXT\_SEGMENT macro
description: The NET\_BUFFER\_SHARED\_MEM\_NEXT\_SEGMENT macro gets the next shared memory segment from a NET\_BUFFER\_SHARED\_MEMORY structure.
MS-HAID:
- 'ndis\_netbuf\_macros\_media\_specific\_e2a5a9a7-5fbe-4cbd-9035-4d264b84aa5e.xml'
- 'netvista.net\_buffer\_shared\_mem\_next\_segment'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 6c2445c5-166e-42c9-aa95-d7c6878571e3
keywords: ["NET_BUFFER_SHARED_MEM_NEXT_SEGMENT macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
