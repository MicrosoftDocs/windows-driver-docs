...
### [Receive Filter Status Indications](netvista/receive-filter-status-indications.md)
#### [NDIS_STATUS_RECEIVE_FILTER_CURRENT_CAPABILITIES](netvista/ndis-status-receive-filter-current-capabilities.md)
#### [NDIS_STATUS_RECEIVE_FILTER_HARDWARE_CAPABILITIES](netvista/ndis-status-receive-filter-hardware-capabilities.md)
### [NDIS General Status Indications](netvista/ndis-general-status-indications.md)
#### [NDIS_STATUS_MEDIA_CONNECT](netvista/ndis-status-media-connect.md)
#### [NDIS_STATUS_MEDIA_DISCONNECT](netvista/ndis-status-media-disconnect.md)
#### [NDIS_STATUS_RESET_START](netvista/ndis-status-reset-start.md)
#### [NDIS_STATUS_RESET_END](netvista/ndis-status-reset-end.md)
#### [NDIS_STATUS_MEDIA_BUSY](netvista/ndis-status-media-busy.md)
#### [NDIS_STATUS_MEDIA_SPECIFIC_INDICATION](netvista/ndis-status-media-specific-indication.md)
#### [NDIS_STATUS_LINK_SPEED_CHANGE](netvista/ndis-status-link-speed-change.md)
#### [NDIS_STATUS_LINK_STATE](netvista/ndis-status-link-state.md)
#### [NDIS_STATUS_PORT_STATE](netvista/ndis-status-port-state.md)
#### [NDIS_STATUS_OPER_STATUS](netvista/ndis-status-oper-status.md)
#### [NDIS_STATUS_NETWORK_CHANGE](netvista/ndis-status-network-change.md)
#### [NDIS_STATUS_PACKET_FILTER](netvista/ndis-status-packet-filter.md)
### [NDIS QoS Status Indications](netvista/ndis-qos-status-indications.md)
#### [NDIS_STATUS_QOS_OPERATIONAL_PARAMETERS_CHANGE](netvista/ndis-status-qos-operational-parameters-change.md)
#### [NDIS_STATUS_QOS_REMOTE_PARAMETERS_CHANGE](netvista/ndis-status-qos-remote-parameters-change.md)
### [NDIS TCP/IP Offload Status Indications](netvista/ndis-tcp-ip-offload-status-indications.md)
#### [NDIS_STATUS_TASK_OFFLOAD_CURRENT_CONFIG](netvista/ndis-status-task-offload-current-config.md)
#### [NDIS_STATUS_TASK_OFFLOAD_HARDWARE_CAPABILITIES](netvista/ndis-status-task-offload-hardware-capabilities.md)
#### [NDIS_STATUS_OFFLOAD_ENCASPULATION_CHANGE](netvista/ndis-status-offload-encaspulation-change.md)
#### [NDIS_STATUS_TCP_CONNECTION_OFFLOAD_HARDWARE_CAPABILITIES](netvista/ndis-status-tcp-connection-offload-hardware-capabilities.md)
### [NDIS Wake Reason Status Indications](netvista/ndis-wake-reason-status-indications-ref.md)
#### [NDIS_STATUS_PM_WAKE_REASON](netvista/ndis-status-pm-wake-reason.md)
### [NDIS WAN Status Indications](netvista/ndis-wan-status-indications.md)
#### [NDIS_STATUS_WAN_LINE_UP](netvista/ndis-status-wan-line-up.md)
#### [NDIS_STATUS_WAN_LINE_DOWN](netvista/ndis-status-wan-line-down.md)
#### [NDIS_STATUS_WAN_FRAGMENT](netvista/ndis-status-wan-fragment.md)
#### [NDIS_STATUS_TAPI_INDICATION](netvista/ndis-status-tapi-indication.md)
#### [NDIS_STATUS_RING_STATUS](netvista/ndis-status-ring-status.md)
#### [NDIS_STATUS_WW_INDICATION](netvista/ndis-status-ww-indication.md)
#### [NDIS_STATUS_WAN_CO_FRAGMENT](netvista/ndis-status-wan-co-fragment.md)
#### [NDIS_STATUS_WAN_CO_LINKPARAMS](netvista/ndis-status-wan-co-linkparams.md)
#### [NDIS_STATUS_WAN_CO_MTULINKPARAMS](netvista/ndis-status-wan-co-mtulinkparams.md)
...
#### [Header-Data Split Status Indications](netvista/header-data-split-status-indications.md)
##### [NDIS_STATUS_HD_SPLIT_CURRENT_CONFIG](netvista/ndis-status-hd-split-current-config.md)
...
### [PacketDirect Provider Interface (PDPI) Status Indications](netvista/packetdirect-provider-interface--pdpi--status-indications.md)
#### [NDIS_STATUS_PD_CURRENT_CONFIG](netvista/ndis-status-pd-current-config.md)
...
### [Hyper-V Extensible Switch Status Indications](netvista/hyper-v-extensible-switch-status-indications.md)
#### [NDIS_STATUS_SWITCH_NIC_STATUS](netvista/ndis-status-switch-nic-status.md)
#### [NDIS_STATUS_SWITCH_PORT_REMOVE_VF](netvista/ndis-status-switch-port-remove-vf.md)
### [VMQ Status Indications](netvista/virtual-machine-queue-status-indications.md)
#### [NDIS_STATUS_RECEIVE_QUEUE_STATE](netvista/ndis-status-receive-queue-state.md)
...
#### [MB NDIS Status Notifications](netvista/mb-ndis-status-notifications.md)
##### [NDIS_STATUS_WWAN_AUTH_RESPONSE](netvista/ndis-status-wwan-auth-response.md)
##### [NDIS_STATUS_WWAN_DEVICE_CAPS](netvista/ndis-status-wwan-device-caps.md)
##### [NDIS_STATUS_WWAN_DEVICE_CAPS_EX](netvista/ndis-status-wwan-device-caps-ex.md)
##### [NDIS_STATUS_WWAN_DEVICE_SERVICE_EVENT](netvista/ndis-status-wwan-device-service-event.md)
##### [NDIS_STATUS_WWAN_DEVICE_SERVICE_RESPONSE](netvista/ndis-status-wwan-device-service-response.md)
##### [NDIS_STATUS_WWAN_DEVICE_SERVICE_SESSION](netvista/ndis-status-wwan-device-service-session.md)
##### [NDIS_STATUS_WWAN_DEVICE_SERVICE_SESSION_READ](netvista/ndis-status-wwan-device-service-session-read.md)
##### [NDIS_STATUS_WWAN_DEVICE_SERVICE_SESSION_WRITE_COMPLETE](netvista/ndis-status-wwan-device-service-session-write-complete.md)
##### [NDIS_STATUS_WWAN_DEVICE_SERVICE_SUBSCRIPTION](netvista/ndis-status-wwan-device-service-subscription.md)
##### [NDIS_STATUS_WWAN_DEVICE_SERVICE_SUPPORTED_COMMANDS](netvista/ndis-status-wwan-device-service-supported-commands.md)
##### [NDIS_STATUS_WWAN_DEVICE_SLOT_MAPPINGS](netvista/ndis-status-wwan-device-slot-mappings.md)
##### [NDIS_STATUS_WWAN_IP_ADDRESS_STATE](netvista/ndis-status-wwan-ip-address-state.md)
##### [NDIS_STATUS_WWAN_PREFERRED_MULTICARRIER_PROVIDERS](netvista/ndis-status-wwan-preferred-multicarrier-providers.md)
##### [NDIS_STATUS_WWAN_PRESHUTDOWN_STATE](netvista/ndis-status-wwan-preshutdown-state.md)
##### [NDIS_STATUS_WWAN_SET_HOME_PROVIDER_COMPLETE](netvista/ndis-status-wwan-set-home-provider-complete.md)
##### [NDIS_STATUS_WWAN_SLOT_INFO_STATUS](netvista/ndis-status-wwan-slot-info-status.md)
##### [NDIS_STATUS_WWAN_SUPPORTED_DEVICE_SERVICES](netvista/ndis-status-wwan-supported-device-services.md)
##### [NDIS_STATUS_WWAN_SYS_CAPS](netvista/ndis-status-wwan-sys-caps.md)
##### [NDIS_STATUS_WWAN_USSD](netvista/ndis-status-wwan-ussd.md)
...
##### [Native 802.11 WFD Status Indications](netvista/native-802-11-wfd-status-indications.md)
###### [NDIS_STATUS_DOT11_WFD_DISCOVER_COMPLETE](netvista/ndis-status-dot11-wfd-discover-complete.md)
###### [NDIS_STATUS_DOT11_WFD_GO_NEGOTIATION_CONFIRMATION_SEND_COMPLETE](netvista/ndis-status-dot11-wfd-go-negotiation-confirmation-send-complete.md)
###### [NDIS_STATUS_DOT11_WFD_GO_NEGOTIATION_REQUEST_SEND_COMPLETE](netvista/ndis-status-dot11-wfd-go-negotiation-request-send-complete.md)
###### [NDIS_STATUS_DOT11_WFD_GO_NEGOTIATION_RESPONSE_SEND_COMPLETE](netvista/ndis-status-dot11-wfd-go-negotiation-response-send-complete.md)
###### [NDIS_STATUS_DOT11_WFD_GROUP_OPERATING_CHANNEL](netvista/-ndis-status-dot11-wfd-group-operating-channel.md)
###### [NDIS_STATUS_DOT11_WFD_INVITATION_REQUEST_SEND_COMPLETE](netvista/ndis-status-dot11-wfd-invitation-request-send-complete.md)
###### [NDIS_STATUS_DOT11_WFD_INVITATION_RESPONSE_SEND_COMPLETE](netvista/ndis-status-dot11-wfd-invitation-response-send-complete.md)
###### [NDIS_STATUS_DOT11_WFD_PROVISION_DISCOVERY_REQUEST_SEND_COMPLETE](netvista/ndis-status-dot11-wfd-provision-discovery-request-send-complete.md)
###### [NDIS_STATUS_DOT11_WFD_PROVISION_DISCOVERY_RESPONSE_SEND_COMPLETE](netvista/ndis-status-dot11-wfd-provision-discovery-response-send-complete.md)
###### [NDIS_STATUS_DOT11_WFD_RECEIVED_GO_NEGOTIATION_CONFIRMATION](netvista/ndis-status-dot11-wfd-received-go-negotiation-confirmation.md)
###### [NDIS_STATUS_DOT11_WFD_RECEIVED_GO_NEGOTIATION_REQUEST](netvista/ndis-status-dot11-wfd-received-go-negotiation-request.md)
###### [NDIS_STATUS_DOT11_WFD_RECEIVED_GO_NEGOTIATION_RESPONSE](netvista/ndis-status-dot11-wfd-received-go-negotiation-response.md)
###### [NDIS_STATUS_DOT11_WFD_RECEIVED_INVITATION_REQUEST](netvista/ndis-status-dot11-wfd-received-invitation-request.md)
###### [NDIS_STATUS_DOT11_WFD_RECEIVED_INVITATION_RESPONSE](netvista/ndis-status-dot11-wfd-received-invitation-response.md)
###### [NDIS_STATUS_DOT11_WFD_RECEIVED_PROVISION_DISCOVERY_REQUEST](netvista/ndis-status-dot11-wfd-received-provision-discovery-request.md)
###### [NDIS_STATUS_DOT11_WFD_RECEIVED_PROVISION_DISCOVERY_RESPONSE](netvista/ndis-status-dot11-wfd-received-provision-discovery-response.md)
...
### [WSK Client Control Operations](netvista/wsk-client-control-operations.md)
#### [WSK_CACHE_SD](netvista/wsk-cache-sd.md)
#### [WSK_RELEASE_SD](netvista/wsk-release-sd.md)
#### [WSK_SET_STATIC_EVENT_CALLBACKS](netvista/wsk-set-static-event-callbacks.md)
#### [WSK_TDI_BEHAVIOR](netvista/wsk-tdi-behavior.md)
#### [WSK_TDI_DEVICENAME_MAPPING](netvista/wsk-tdi-devicename-mapping.md)
#### [WSK_TRANSPORT_LIST_CHANGE](netvista/wsk-transport-list-change.md)
#### [WSK_TRANSPORT_LIST_QUERY](netvista/wsk-transport-list-query.md)
### [WSK Socket IOCTL Operations](netvista/wsk-socket-ioctl-operations.md)
#### [SIO_WSK_QUERY_IDEAL_SEND_BACKLOG](netvista/sio-wsk-query-ideal-send-backlog.md)
#### [SIO_WSK_QUERY_INSPECT_ID](netvista/sio-wsk-query-inspect-id.md)
#### [SIO_WSK_QUERY_RECEIVE_BACKLOG](netvista/sio-wsk-query-receive-backlog.md)
#### [SIO_WSK_REGISTER_EXTENSION](netvista/sio-wsk-register-extension.md)
#### [SIO_WSK_SET_REMOTE_ADDRESS](netvista/sio-wsk-set-remote-address.md)
#### [SIO_WSK_SET_SENDTO_ADDRESS](netvista/sio-wsk-set-sendto-address.md)
#### [SIO_WSK_SET_TCP_SILENT_MODE](netvista/sio-wsk-set-tcp-silent-mode.md)
### [WSK Socket Options](netvista/wsk-socket-options.md)
#### [SO_WSK_EVENT_CALLBACK](netvista/so-wsk-event-callback.md)
#### [SO_WSK_SECURITY](netvista/so-wsk-security.md)
