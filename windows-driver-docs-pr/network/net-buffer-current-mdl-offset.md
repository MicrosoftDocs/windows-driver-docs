---
title: NET\_BUFFER\_CURRENT\_MDL\_OFFSET macro
description: NET\_BUFFER\_CURRENT\_MDL\_OFFSET is a macro that NDIS drivers use to get the CurrentMdlOffset member of a NET\_BUFFER structure.
MS-HAID:
- 'ndis\_netbuf\_macros\_ref\_8f873bdf-ee42-4d3e-b09a-37c50bbfa2d1.xml'
- 'netvista.net\_buffer\_current\_mdl\_offset'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 49b14d42-584f-40de-8ba7-d0a74800886a
keywords: ["NET_BUFFER_CURRENT_MDL_OFFSET macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
