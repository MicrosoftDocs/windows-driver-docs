---
title: NET\_BUFFER\_FIRST\_MDL macro
description: NET\_BUFFER\_FIRST\_MDL is a macro that NDIS drivers use to get the first MDL in a NET\_BUFFER structure.
MS-HAID:
- 'ndis\_netbuf\_macros\_ref\_d377490a-9606-495d-852d-3ee195dce93e.xml'
- 'netvista.net\_buffer\_first\_mdl'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: d62c7183-ef28-408a-b862-6a2d97026b35
keywords: ["NET_BUFFER_FIRST_MDL macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
