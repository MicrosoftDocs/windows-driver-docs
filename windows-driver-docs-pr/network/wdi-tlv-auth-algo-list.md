---
title: WDI\_TLV\_AUTH\_ALGO\_LIST
description: WDI\_TLV\_AUTH\_ALGO\_LIST is a TLV that contains a list of authentication algorithms.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 6F5EC21B-C923-45ED-B62E-302D916AABE5
keywords: ["WDI_TLV_AUTH_ALGO_LIST Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
