---
title: WDI\_TLV\_P2P\_SEND\_ACTION\_REQUEST\_FRAME\_PARAMETERS
description: WDI\_TLV\_P2P\_SEND\_ACTION\_REQUEST\_FRAME\_PARAMETERS is a TLV that contains parameters for sending a Wi-Fi Direct action request frame with OID\_WDI\_TASK\_P2P\_SEND\_REQUEST\_ACTION\_FRAME.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 802654D0-CC8E-4808-8C1B-BAAF4C6E53F1
keywords: ["WDI_TLV_P2P_SEND_ACTION_REQUEST_FRAME_PARAMETERS Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
