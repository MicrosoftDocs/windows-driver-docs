...
For more information, see [Setting the Power State of a Virtual Function](https://docs.microsoft.com/windows-hardware/drivers/network/setting-the-power-state-of-a-virtual-function).
