---
title: NDIS\_STATUS\_OPER\_STATUS
description: The NDIS\_STATUS\_OPER\_STATUS status indicates the current operational state of an NDIS network interface to overlying drivers.
MS-HAID:
- 'ndis\_status\_indications\_ref\_6ccb72ff-9c0f-4316-b7a9-5fe824e07ffe.xml'
- 'netvista.ndis\_status\_oper\_status'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: dbe7ce19-290d-4a48-a6c2-1b95e956c26c
keywords: ["NDIS_STATUS_OPER_STATUS Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
