...
| [Network Module Registrar](introduction-to-the-network-module-registrar.md) | A system facility that allows a driver to attach network modules to one another. |
