---
title: OID\_GEN\_PCI\_DEVICE\_CUSTOM\_PROPERTIES
...
NDIS returns an [**NDIS\_PCI\_DEVICE\_CUSTOM\_PROPERTIES**](ndis-pci-device-custom-properties.md) structure that contains the PCI custom properties.
