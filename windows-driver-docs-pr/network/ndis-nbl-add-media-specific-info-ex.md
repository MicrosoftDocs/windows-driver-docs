...
MS-HAID:
- 'ndis\_netbuf\_macros\_media\_specific\_f4f18f25-d48a-4d4b-96e0-1157a461165a.xml'
- 'netvista.ndis\_nbl\_add\_media\_specific\_info\_ex'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: eca59601-ea2a-4e22-b4f7-53b966f4a177
keywords: ["NDIS_NBL_ADD_MEDIA_SPECIFIC_INFO_EX macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
