---
title: WDI\_TLV\_PORT\_ATTRIBUTES
description: WDI\_TLV\_PORT\_ATTRIBUTES is a TLV that contains port attributes.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: F5A0BC8D-1B86-41C2-A530-860E15775695
keywords: ["WDI_TLV_PORT_ATTRIBUTES Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
