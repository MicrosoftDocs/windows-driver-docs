...
If the adapter supports Wi-Fi Direct, both [**WDI\_TLV\_AP\_ATTRIBUTES**](https://docs.microsoft.com/windows-hardware/drivers/network/wdi-tlv-ap-attributes) and [**WDI\_TLV\_P2P\_ATTRIBUTES**](https://docs.microsoft.com/windows-hardware/drivers/network/wdi-tlv-p2p-attributes) must be specified.
...
<p>A list of GUIDs that are passed on to NDIS when WDI is queried for <a href="https://docs.microsoft.com/windows-hardware/drivers/network/oid-gen-supported-guids" data-raw-source="[OID_GEN_SUPPORTED_GUIDS](https://docs.microsoft.com/windows-hardware/drivers/network/oid-gen-supported-guids)">OID_GEN_SUPPORTED_GUIDS</a>.</p></td>
</tr>
<tr class="odd">
