...
For more information about how to allocate VF resources, see [Allocating Resources for a Virtual Function](https://docs.microsoft.com/windows-hardware/drivers/network/allocating-resources-for-a-virtual-function).
...
****
[**NDIS\_MAKE\_RID**](https://docs.microsoft.com/windows-hardware/drivers/network/ndis-make-rid)
