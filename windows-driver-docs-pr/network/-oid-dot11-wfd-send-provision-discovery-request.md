...
The data type for OID\_DOT11\_WFD\_SEND\_PROVISION\_DISCOVERY\_REQUEST is the [**DOT11\_SEND\_PROVISION\_DISCOVERY\_REQUEST\_PARAMETERS**](dot11-send-provision-discovery-request-parameters.md) structure.
...
[**DOT11\_SEND\_PROVISION\_DISCOVERY\_REQUEST\_PARAMETERS**](dot11-send-provision-discovery-request-parameters.md)
