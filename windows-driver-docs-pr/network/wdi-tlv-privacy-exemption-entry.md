...
| [**WDI\_EXEMPTION\_ACTION\_TYPE**](https://docs.microsoft.com/windows-hardware/drivers/ddi/dot11wdi/ne-dot11wdi-_wdi_exemption_action_type) | Specifies the action type of the exemption.                 |
| [**WDI\_EXEMPTION\_PACKET\_TYPE**](https://docs.microsoft.com/windows-hardware/drivers/ddi/wditypes/ne-wditypes-_wdi_exemption_packet_type) | Specifies the type of packet that the exemption applies to. |
