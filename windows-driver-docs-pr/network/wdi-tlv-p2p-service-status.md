---
title: WDI\_TLV\_P2P\_SERVICE\_STATUS
description: WDI\_TLV\_P2P\_SERVICE\_STATUS is a TLV that contains the Service Status of a service.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: C7001661-8496-4C5B-9AD2-EF92332AF377
keywords: ["WDI_TLV_P2P_SERVICE_STATUS Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
