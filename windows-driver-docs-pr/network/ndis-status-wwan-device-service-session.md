---
title: NDIS\_STATUS\_WWAN\_DEVICE\_SERVICE\_SESSION
description: Miniport drivers use the NDIS\_STATUS\_WWAN\_DEVICE\_SERVICE\_SESSION indication to report the completion of a device service session state change originated by OID\_WWAN\_DEVICE\_SERVICE\_SESSION.NDIS\_WWAN\_DEVICE\_SERVICE\_SESSION\_INFO structure.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 0A3D8323-20F1-4405-97D4-0E497946118E
keywords: ["NDIS_STATUS_WWAN_DEVICE_SERVICE_SESSION Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
