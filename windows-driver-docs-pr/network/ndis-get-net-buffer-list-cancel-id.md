---
title: NDIS\_GET\_NET\_BUFFER\_LIST\_CANCEL\_ID macro
description: The NDIS\_GET\_NET\_BUFFER\_LIST\_CANCEL\_ID macro gets the cancellation identifier from a NET\_BUFFER\_LIST structure.
MS-HAID:
- 'ndis\_sendrcv\_ref\_a9c19a42-ce80-49b4-987f-5f1650bbd5c1.xml'
- 'netvista.ndis\_get\_net\_buffer\_list\_cancel\_id'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: ad302c12-24d9-4310-ac5a-dd295589fcbd
keywords: ["NDIS_GET_NET_BUFFER_LIST_CANCEL_ID macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
