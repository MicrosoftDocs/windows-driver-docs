...
To access reference topics related to the Cellular COM API, see [Cellular COM API reference](https://msdn.microsoft.com/library/windows/hardware/dn946508). The Cellular COM API was used in Windows Phone 8.1 and is deprecated in Windows 10 and later.
