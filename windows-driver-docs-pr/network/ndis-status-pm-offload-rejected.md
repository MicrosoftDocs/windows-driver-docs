...
MS-HAID:
- 'miniport\_power\_management\_ref\_4f701f0c-f543-41d9-8a2d-a7566e7a1065.xml'
- 'netvista.ndis\_status\_pm\_offload\_rejected'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 54922e70-2b56-4141-b79b-73418c7553e3
keywords: ["NDIS_STATUS_PM_OFFLOAD_REJECTED Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
