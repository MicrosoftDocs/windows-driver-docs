---
title: WDI\_TLV\_INDICATION\_STOP\_AP
description: WDI\_TLV\_INDICATION\_STOP\_AP is a TLV that contains the reason for a Stop AP indication.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 49FA6AF6-68BE-437B-9715-5090F52F0109
keywords: ["WDI_TLV_INDICATION_STOP_AP Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
