...
MS-HAID:
- 'wskref\_51c01632-28d2-450e-a84b-a24939d3805d.xml'
- 'netvista.wsk\_tdi\_devicename\_mapping'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 7636fa80-3908-4808-8fb8-6227ec6e023b
keywords: ["WSK_TDI_DEVICENAME_MAPPING Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
