...
:::image type="content" source="./images/ndis-traditional-dpc-diagram.png" alt-text="Diagram showing the NDIS DPC model with Rx packets and hardware queue.":::
...
:::image type="content" source="./images/ndis-poll-mode-sequence-diagram.png" alt-text="Diagram showing NDIS Poll Mode with Rx packets and hardware queue.":::
