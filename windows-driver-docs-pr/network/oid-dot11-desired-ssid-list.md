---
title: OID_DOT11_DESIRED_SSID_LIST
author: windows-driver-content
description: When set, the OID_DOT11_DESIRED_SSID_LIST object identifier (OID) requests that the miniport driver set the value of the msDot11DesiredSSIDList management information base (MIB) object to the specified data.
