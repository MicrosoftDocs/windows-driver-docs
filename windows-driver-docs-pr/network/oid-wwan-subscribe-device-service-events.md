...
Callers requesting to set the MB device service event subscription list provide a [**NDIS\_WWAN\_SUBSCRIBE\_DEVICE\_SERVICE\_EVENTS**](ndis-wwan-subscribe-device-service-events.md) structure to the miniport driver with the appropriate information.
...
[**NDIS\_WWAN\_SUBSCRIBE\_DEVICE\_SERVICE\_EVENTS**](ndis-wwan-subscribe-device-service-events.md)
