...
MS-HAID:
- 'wskref\_10ee3dae-93f3-4c0e-8949-970874e51207.xml'
- 'netvista.sio\_wsk\_query\_inspect\_id'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 6fc3e5ea-61df-47fc-8f79-f9ae272b3544
keywords: ["SIO_WSK_QUERY_INSPECT_ID Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
