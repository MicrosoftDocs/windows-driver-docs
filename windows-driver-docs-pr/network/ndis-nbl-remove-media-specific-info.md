...
MS-HAID:
- 'ndis\_netbuf\_macros\_ref\_a6a1e8e3-72d2-4cff-8692-7181ebdf282d.xml'
- 'netvista.ndis\_nbl\_remove\_media\_specific\_info'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 70aeef03-208b-4d09-9e0a-dd3571367ae5
keywords: ["NDIS_NBL_REMOVE_MEDIA_SPECIFIC_INFO macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
