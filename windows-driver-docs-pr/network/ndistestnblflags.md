...
MS-HAID:
- 'ndis\_netbuf\_macros\_nblflags\_ref\_ee0fde76-dc00-4761-a8f6-fa7970950a29.xml'
- 'netvista.ndistestnblflags'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: adddae72-11ff-44f0-ac90-5792e0203b64
keywords: ["NdisTestNblFlags macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
- NdisTestNblFlags
