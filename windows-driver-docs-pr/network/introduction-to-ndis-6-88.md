...
description: This section introduces NDIS 6.88 and describes changes from NDIS 6.87. NDIS 6.88 is included in Windows 11, version 23H2.
ms.date: 03/08/2024
---

# Introduction to NDIS 6.88

This topic introduces Network Driver Interface Specification (NDIS) 6.88 and describes its major design additions. NDIS 6.88 is included in Windows 11, version 23H2 and Windows Server 2022 and later.
...
- NDIS 6.88 miniport drivers for Windows 11, version 23H2 and Windows Server 2022 and later must use the NDIS 6.88 versions of data structures.
