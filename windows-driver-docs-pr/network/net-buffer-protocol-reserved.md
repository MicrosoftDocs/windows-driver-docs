---
title: NET\_BUFFER\_PROTOCOL\_RESERVED macro
description: NET\_BUFFER\_PROTOCOL\_RESERVED is a macro that NDIS drivers use to get the ProtocolReserved member of a NET\_BUFFER structure.
MS-HAID:
- 'ndis\_netbuf\_macros\_ref\_c433fd2f-2fca-4e6b-b5de-c72a50b4cc24.xml'
- 'netvista.net\_buffer\_protocol\_reserved'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: ab46cce0-c77f-4e08-9522-6a6674d557e8
keywords: ["NET_BUFFER_PROTOCOL_RESERVED macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
