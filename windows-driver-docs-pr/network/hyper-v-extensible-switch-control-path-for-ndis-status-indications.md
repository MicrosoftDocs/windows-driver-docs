...
:::image type="content" source="images/vswitch-status-controlpath2-ndis640.png" alt-text="Diagram that shows the control path for NDIS status indications from an extensible switch team for NDIS 6.40 in Windows Server 2012 R2.":::
...
:::image type="content" source="images/vswitch-status-controlpath2.png" alt-text="Diagram that shows the control path for NDIS status indications from an extensible switch team for NDIS 6.30 in Windows Server 2012.":::
