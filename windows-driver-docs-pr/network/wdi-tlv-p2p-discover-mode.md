---
title: WDI\_TLV\_P2P\_DISCOVER\_MODE
description: WDI\_TLV\_P2P\_DISCOVER\_MODE is a TLV that contains Wi-Fi Direct discovery mode information for OID\_WDI\_TASK\_P2P\_DISCOVER.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 430DDDBE-C861-4E85-BFAB-31670F77696D
keywords: ["WDI_TLV_P2P_DISCOVER_MODE Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
