...
Hyper-V extensible switch extensions use the **NDIS\_ROUTING\_DOMAIN\_ISOLATION\_ENTRY\_GET\_NEXT** macro to access the next [**NDIS\_ROUTING\_DOMAIN\_ISOLATION\_ENTRY**](ndis-routing-domain-isolation-entry.md) element that follows an **NDIS\_ROUTING\_DOMAIN\_ISOLATION\_ENTRY** structure in the array that is specified by an [**NDIS\_SWITCH\_PORT\_PROPERTY\_ROUTING\_DOMAIN**](ndis-switch-port-property-routing-domain.md) structure.
...
A pointer to an [**NDIS\_ROUTING\_DOMAIN\_ISOLATION\_ENTRY**](ndis-routing-domain-isolation-entry.md) structure.

Return value
------------

The **NDIS\_ROUTING\_DOMAIN\_ISOLATION\_ENTRY\_GET\_NEXT** macro returns a pointer to the next [**NDIS\_ROUTING\_DOMAIN\_ISOLATION\_ENTRY**](ndis-routing-domain-isolation-entry.md) element in the array. If the *\_IsolationInfoEntry\_* parameter already points to the last element in the array, the macro returns **NULL**.
...
[**NDIS\_SWITCH\_PORT\_PROPERTY\_ROUTING\_DOMAIN**](ndis-switch-port-property-routing-domain.md)
