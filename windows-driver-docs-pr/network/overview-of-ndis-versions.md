...
> [!NOTE]
> A driver can query the NDIS version by calling the [**NdisReadConfiguration**](https://docs.microsoft.com/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisreadconfiguration) function with the *Keyword* parameter set to **NdisVersion**. 
