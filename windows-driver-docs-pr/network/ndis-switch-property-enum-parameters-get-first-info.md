---
title: NDIS\_SWITCH\_PROPERTY\_ENUM\_PARAMETERS\_GET\_FIRST\_INFO macro
description: Hyper-V extensible switch extensions use the NDIS\_SWITCH\_PROPERTY\_ENUM\_PARAMETERS\_GET\_FIRST\_INFO macro to access the first NDIS\_SWITCH\_PROPERTY\_ENUM\_INFO element that is specified by an NDIS\_SWITCH\_PROPERTY\_ENUM\_PARAMETERS structure.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: C12E4047-A558-4812-A9F9-6AA68FF10928
keywords: ["NDIS_SWITCH_PROPERTY_ENUM_PARAMETERS_GET_FIRST_INFO macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
