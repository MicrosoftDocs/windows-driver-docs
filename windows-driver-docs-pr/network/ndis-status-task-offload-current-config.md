...
MS-HAID:
- 'tcpip\_offload\_ref\_22c7b5e1-8826-46c8-8163-09fa85563286.xml'
- 'netvista.ndis\_status\_task\_offload\_current\_config'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 8a098dff-409e-4168-a3aa-372851aa999d
keywords: ["NDIS_STATUS_TASK_OFFLOAD_CURRENT_CONFIG Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
