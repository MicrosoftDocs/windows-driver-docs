...
This notification uses the [**NDIS\_WWAN\_SMS\_DELETE\_STATUS**](ndis-wwan-sms-delete-status.md) structure.
...
[**NDIS\_WWAN\_SMS\_DELETE\_STATUS**](ndis-wwan-sms-delete-status.md)
