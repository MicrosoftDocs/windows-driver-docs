...
:::image type="content" source="images/d0onconnect.png" alt-text="Diagram illustrating the sequence of events to restore full power to a network adapter after a media connect event.":::
