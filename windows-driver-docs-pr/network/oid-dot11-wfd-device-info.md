...
The data type for OID\_DOT11\_WFD\_DEVICE\_INFO is the [**DOT11\_WFD\_DEVICE\_INFO**](-dot11-wfd-device-info.md) structure.

The miniport retains the attribute information from the [**DOT11\_WFD\_DEVICE\_INFO**](-dot11-wfd-device-info.md) structure for use in later response operations.
...
[**DOT11\_WFD\_DEVICE\_INFO**](-dot11-wfd-device-info.md)
