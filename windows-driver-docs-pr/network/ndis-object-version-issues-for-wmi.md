...
The NDIS\_WMI\_Xxx\_HEADER structures have a new revision when more members are added for a new NDIS version. For a list of the current NDIS\_WMI\_Xxx\_HEADER structures, see [NDIS WMI Structures](https://docs.microsoft.com/windows-hardware/drivers/ddi/ntddndis/index).
