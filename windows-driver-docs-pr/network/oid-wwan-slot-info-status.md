...
Miniport drivers must process query requests asynchronously, initially returning NDIS\_STATUS\_INDICATION\_REQUIRED to the original request before later sending an [**NDIS\_STATUS\_WWAN\_SLOT\_INFO**](https://msdn.microsoft.com/library/windows/hardware/mt782398) status notification containing an [**NDIS\_WWAN\_SLOT\_INFO**](ndis-wwan-slot-info-status.md) structure, which in turn contains a [**WWAN\_SLOT\_INFO**](wwan-slot-info-status.md) structure, to provide information about the overall modem system capability.

Query requests specify [**NDIS\_WWAN\_GET\_SLOT\_INFO**](ndis-wwan-get-slot-info-status.md) structure as input. The miniport driver should return the slot status according to the slot ID specified in the **SlotIndex** member of the [**WWAN\_GET\_SLOT\_INFO**](wwan-get-slot-info-status.md) structure.
...
An [**NDIS\_STATUS\_WWAN\_SLOT\_INFO**](https://msdn.microsoft.com/library/windows/hardware/mt782398) notification with a [**NDIS\_WWAN\_SLOT\_INFO**](ndis-wwan-slot-info-status.md) structure is sent to host when the slot/card state changes.
...
[**NDIS\_WWAN\_SLOT\_INFO**](ndis-wwan-slot-info-status.md)

[**WWAN\_SLOT\_INFO**](wwan-slot-info-status.md)

[**NDIS\_WWAN\_GET\_SLOT\_INFO**](ndis-wwan-get-slot-info-status.md)

[**WWAN\_GET\_SLOT\_INFO**](wwan-get-slot-info-status.md)

[**WWAN\_UICCSLOT\_STATE**](wwan-uiccslot-state.md)
