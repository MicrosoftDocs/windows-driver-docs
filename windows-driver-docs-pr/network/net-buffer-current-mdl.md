...
MS-HAID:
- 'ndis\_netbuf\_macros\_ref\_8d9ec05a-0bbd-4e26-aa6b-1cf384399bc3.xml'
- 'netvista.net\_buffer\_current\_mdl'
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: c2fc283f-13b7-4c04-96c2-4bc1ea811a17
keywords: ["NET_BUFFER_CURRENT_MDL macro Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
