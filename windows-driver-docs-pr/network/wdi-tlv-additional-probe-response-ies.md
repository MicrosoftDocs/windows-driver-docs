---
title: WDI\_TLV\_ADDITIONAL\_PROBE\_RESPONSE\_IES
description: WDI\_TLV\_ADDITIONAL\_PROBE\_RESPONSE\_IES is a TLV that contains probe response IEs.
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: BDEDAD4D-A35B-4AE9-BC90-184CD75002B2
keywords: ["WDI_TLV_ADDITIONAL_PROBE_RESPONSE_IES Network Drivers Starting with Windows Vista"]
topic_type:
- apiref
api_name:
- WDI_TLV_ADDITIONAL_PROBE_RESPONSE_IES
api_location:
- wditypes.hpp
api_type:
- HeaderDef
