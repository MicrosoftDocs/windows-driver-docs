...
:::image type="content" source="images/cm-09.png" alt-text="Diagram showing a client of a call manager initiating the deletion of a virtual circuit.":::

The following figure shows a client of an MCM driver initiating the deletion of a VC.

:::image type="content" source="images/fig1-09.png" alt-text="Diagram showing a client of an MCM driver initiating the deletion of a virtual circuit.":::

The following figure shows a call manager initiating the deletion of a VC.

:::image type="content" source="images/cm-10.png" alt-text="Diagram showing a call manager initiating the deletion of a virtual circuit.":::
...
:::image type="content" source="images/fig1-10.png" alt-text="Diagram showing an MCM driver initiating the deletion of a virtual circuit.":::
