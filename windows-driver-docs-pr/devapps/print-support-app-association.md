...
> **Note:** Windows Server does not support Microsoft Store. Therefore, Print Support Apps (PSAs) cannot be automatically downloaded or installed from the Store on Windows Server. Administrators must provide and install PSAs via sideloading (MSIX/APPX) or through enterprise app management tools.  
