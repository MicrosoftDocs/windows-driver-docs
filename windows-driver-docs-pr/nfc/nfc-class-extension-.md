...
-   [Near Field Proximity DDI](https://docs.microsoft.com/windows-hardware/drivers/ddi/index)
-   [NFC Secure Element Management DDI](https://docs.microsoft.com/windows-hardware/drivers/ddi/index)
-   [Smart Card DDI for contactless smart card access](https://docs.microsoft.com/previous-versions/dn905601(v=vs.85))
-   [NFC Radio Management DDI](https://docs.microsoft.com/windows-hardware/drivers/ddi/index)
...
## Related topics
[NFC device driver interface (DDI) overview](https://docs.microsoft.com/windows-hardware/drivers/ddi/_nfpdrivers/)  
[NFC class extension (CX) reference](https://docs.microsoft.com/windows-hardware/drivers/ddi/nfccx/)  
