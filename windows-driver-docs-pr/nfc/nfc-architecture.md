...
-   [Smart Card DDI](https://msdn.microsoft.com/library/windows/hardware/dn905602) – Provides low level access for interacting with smart cards like ability to listen for card arrival/departure, allows requests to be transmitted to the smart card, and allows smart card information to be retrieved.
